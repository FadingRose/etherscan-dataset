...
contract MAOA is ERC20, Ownable {
    ...
    constructor() ERC20("Making America #1 Again", "MAOA") payable {
        uint256 totalSupply = 420690000000 * 1e9;
        uint256 lpSupply = totalSupply * 76 / 100;
        uint256 caSupply = totalSupply * 24 / 100;

        feeReceiver = 0x6228e2ab0ceF3FB5A98bB66eB92bC4B8e4055a93;
