/*
🇺🇸 Website - https://Donaldtrumpnews.news
🇺🇸 Twitter - https://x.com/dtnews_eth?s=21
🇺🇸 Telegram - https://t.me/donaldtrumpnewsETH
*/
...
contract DTN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Donald Trump News";
    string private constant _symbol = unicode"DTN";
    ...
    constructor () {
        _taxWallet = payable(0xe5B4F6B64F0dedFe050eB45f9aD9ef1e0EfB204e);
