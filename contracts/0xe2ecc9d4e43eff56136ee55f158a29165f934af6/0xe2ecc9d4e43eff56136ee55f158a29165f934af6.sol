...
contract Gunman is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mark Sanchez";
    string private constant _symbol = unicode"GUNMAN";
    ...
    constructor () {
        ...
        _teamWallet = payable(0xE5ca3A65B3F485AA9cE15e2Cd2EB8fA78dAD012f);
