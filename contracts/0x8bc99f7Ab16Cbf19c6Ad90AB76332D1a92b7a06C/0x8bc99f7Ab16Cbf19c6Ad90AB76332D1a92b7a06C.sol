...
/*
    Website - https://pepetheplatypus.lol
    Twitter - https://x.com/pepeplatypusERC
    Telegram- https://t.me/pepeplatypusERC
*/
...
contract PTP  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private constant _name = unicode"PEPE THE PLATYPUS";
    ...
    constructor() {
        _taxWallet = payable(0x73894dfbAD977AE17784d9e66C22Cf416c69588A);
    ...
    function createPTP() external onlyOwner {
    ...
    function enablePTP() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
