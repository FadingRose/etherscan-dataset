...
contract NT is ERC20, Ownable {
    ...
    uint256 private maxFeeSwap = 20000000 * 1e9;
    ...
    constructor() ERC20("New Token", "NT") payable {
        uint256 totalSupply = 1000000000 * 1e9;

        feeReceiver = 0x094B658c883B49d331Aa34C29132E2Ef62ff1e0A;
        buyFee = 24;
        sellFee = 24;
    ...
    function openTrading() external payable onlyOwner {
        ...
        _router.addLiquidityETH{value: 1500000000000000000}(address(this), 760000000000000000, 0, 0, msg.sender, block.timestamp);
