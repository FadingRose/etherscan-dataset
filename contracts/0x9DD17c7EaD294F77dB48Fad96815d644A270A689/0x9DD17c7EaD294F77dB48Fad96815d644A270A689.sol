...
contract FRINKCOIN is ERC20, Ownable {
    ...
    // 1% is max wallet
    uint256 public maxWallet = (initialTotalSupply * 10)/100;
    ...
    constructor() ERC20("Frinkcoin", "FRINKCOIN"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0xc904E142feBAA8Fe29769941aE377fA8D2335c9d);
    ...
    function addLPToUniswap() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0xc904E142feBAA8Fe29769941aE377fA8D2335c9d,
            block.timestamp
        );
