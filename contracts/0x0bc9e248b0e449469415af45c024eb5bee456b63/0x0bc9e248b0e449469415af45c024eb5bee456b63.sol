...
/**
 * Website: https://scroll.bet
 * Telegram: https://t.me/ScrollBetCassino
 * Twitter: https://twitter.com/Scroll_Bet
 */
...
contract ScrollBetToken is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    ...
    uint256 private constant MAX_TAX = 500; // 500 is the maximum tax value
    ...
    function setTax(uint256 tax_) public onlyOwner {
        require(tax_ <= MAX_TAX, "Tax too high");
        require(tax_ != tax, "Same tax value");
    ...
    function openManualTrading(address uniswapV2Router_, address pairAddress_) external onlyOwner {
        require(!tradingOpen, "Trading is already open");
