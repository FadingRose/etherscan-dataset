...
/*
Telegram: https://t.me/MiTrumpEth
Website: https://MiTrump.xyz
X: https://x.com/MiTrumpEth
*/
...
contract MiTrump is IERC20, Auth {
    ...
    address payable private _walletMarketing = payable(0x179cf1b2ff6a76B91174405C0a7F41171a67f2f3); 
    ...
    function setFees(uint8 buy, uint8 sell) external onlyOwner {
        require(buy + sell <= 39, "Roundtrip too high");
        _buyTaxRate = buy;
        _sellTaxRate = sell;
    }  
