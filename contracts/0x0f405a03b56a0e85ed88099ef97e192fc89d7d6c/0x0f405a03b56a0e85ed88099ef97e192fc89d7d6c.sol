...
contract DARKMUSK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DARK MUSK";
    ...
    constructor () {
        ...
        _balances[_elonWallet] = _tTotal.mul(6).div(100);
        _balances[address(this)] = _tTotal.mul(94).div(100);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        emit Transfer(address(0), _elonWallet, _tTotal.mul(6).div(100));
