...
// SPDX-License-Identifier: UNLICENSE
    ...
    BIDEN IS $ALIVE BUT THEY AREN'T TELLING US

    $ALIVE
    BIDENISALIVE

    Telegram: https://t.me/BIDENISALIVEENTRY
    Twitter: https://x.com/ALIVEBIDEN
    Website: https://www.alivebiden.com/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BIDENISALIVE";
    string private constant _symbol = unicode"ALIVE";
