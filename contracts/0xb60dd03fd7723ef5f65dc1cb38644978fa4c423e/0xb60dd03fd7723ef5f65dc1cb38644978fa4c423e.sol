...
contract Giga is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Giga", unicode"GG") {
        ...
        maxWallet = totalSupply * 15 / 1000; // 2% max wallet 
        ...
        marketingWallet = address(0xDD7E4D964CfEc3CBd8A3C23ec1218b6506a97Dc2); // marketingwallet
        devWallet = address(0xDD7E4D964CfEc3CBd8A3C23ec1218b6506a97Dc2); // devwallet
