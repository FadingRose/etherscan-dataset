...
contract HOPO_PIPO_marketing_LAUCNH_TOMORROW_4PM_UTC {
    string public constant NAME = "HOPO PIPO launch tomorrow 4pm UTC";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 4000000000 * (10 ** uint256(DECIMALS));
