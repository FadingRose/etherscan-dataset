...
/*
    Pete Buttigieg - 2024 President! 

    https://t.me/PeteButtigiegCoin

    https://x.com/Buttigieg_ERC
    
    https://petebuttigiegerc.xyz/ 
*/
...
contract BUTTIGIEG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pete Buttigieg";
    string private constant _symbol = unicode"BUTTIGIEG";
