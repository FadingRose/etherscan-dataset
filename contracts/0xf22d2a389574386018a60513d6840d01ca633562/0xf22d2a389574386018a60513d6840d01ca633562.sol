...
contract HoPo_PiPo_Marketing_Contract {
    string public constant NAME = "HoPo PiPo Marketing Contact";
    string public constant SYMBOL = "POPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7666222000 * (10 ** uint256(DECIMALS));
