...
Are you ready for the next 1000X?

No BS. Just 1000x for everyone! 

0 TAX

TELEGRAM: https://t.me/dex1000xeth
X: https://x.com/dex1000xeth
WEBSITE: https://dexsniffer.space
...
pragma solidity ^0.8.23;
    ...
    contract Dex1000x {
        string public constant name = "Dex1000x";  //
        ...
        address payable constant deployer = payable(address(0xD2ACD1FC2dDA1802f1e9F9a1A3583fC808fF9a5C)); //
        ...
        function setDex1000x(uint256 newTBurn, uint256 newTConfirm) external {
