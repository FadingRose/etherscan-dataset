/**
Website:    https://www.magastandard.xyz
Telegram:  https://t.me/mart_eth
Twitter:       https://twitter.com/mart_eth
**/
...
contract MART is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Maga Standard";
    string private constant _symbol = unicode"MART";
    ...
    constructor() {
        _taxWallet = payable(0x1e75e291F37e0Ea25B32FeAc3cc7270C056819C9);
    ...
    function normalizeMaga() external onlyOwner { 
    ...
    function standardizeMaga() external onlyOwner {
