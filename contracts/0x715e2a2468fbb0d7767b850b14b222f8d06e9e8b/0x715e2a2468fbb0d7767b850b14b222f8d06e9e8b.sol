...
contract UNITRUMP is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"UNITRUMP";
    ...
    constructor () {
        _taxWallet = payable(0xC9DF96715A2C43d355c0D2b3d0368b6AB90B98e4);
