/*
TG: https://t.me/FirstShiba_Erc
Web: https://firstshiba.vip/
X: https://x.com/firstshibaerc
*/
...
contract FirstShiba is ERC20, Ownable {
    ...
    bool public SHIBATradingActive = false;
    bool public SHIBASwapEnabled  = false;
    ...
    constructor() ERC20("First Shiba", "SHIBA") {
        ...
        marketWallet = address(0xC49Bb4aF90277DEeC8b9BF2A74313fEc79580a4f);
        devWallet = address(0xC49Bb4aF90277DEeC8b9BF2A74313fEc79580a4f);
    ...
    function openTrading() external onlyOwner {
        SHIBATradingActive = true;
        SHIBASwapEnabled  = true;
    }
    ...
    function updateSHIBASwapEnabled (bool enabled) external onlyOwner {
        SHIBASwapEnabled  = enabled;
    }
