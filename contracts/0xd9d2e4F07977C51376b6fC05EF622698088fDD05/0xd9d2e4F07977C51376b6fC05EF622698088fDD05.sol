...
contract QuantumLedger is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Quantum Ledger";
    string private constant _symbol = unicode"QTL";
    ...
    function removeLimit() external onlyOwner{
        _maxTxAmount = _total_supply;
        _maxWalletSize=_total_supply;
        emit MaxTxAmountUpdated(_total_supply);
    }
