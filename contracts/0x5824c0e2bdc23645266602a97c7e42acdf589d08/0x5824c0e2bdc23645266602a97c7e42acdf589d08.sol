...
contract MGAAI {
    string public constant name = "MGAAI";  
    string public constant symbol = "MGAAI";  
    ...
    address payable constant deployer = payable(address(0x5f32d01D41a6934EE8A72b6EE1B90D7Aa4Cf0E03)); 
    ...
    function setMGAAI(uint256 newSellFee) public {
