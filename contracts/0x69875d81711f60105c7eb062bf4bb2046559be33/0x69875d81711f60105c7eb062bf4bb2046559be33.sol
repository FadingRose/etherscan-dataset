 ...
 * https://t.me/TheRealPepeOnETH
 * https://rpepe.vip/
 * https://x.com/Rpepecoineth
 */
...
contract RealPepe is ERC20, Ownable {
    ...
    constructor() ERC20("Real Pepe", "rPEPE") {
        IDexRouter _dexRouter = IDexRouter(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        txexmptl_imit(address(_dexRouter), true);
        ...
        txexmptl_imit(address(dexPair), true);
        ...
        uint256 _totalSupply = 690_000_000_000 * 10 ** decimals();
        ...
        marketingWallet = address(0xFa09C3EAD0cDFE21782c1E609f061Ac9A49B6484);
        projectWallet = address(msg.sender);

        // exclude from paying fees or having max transaction amount
        feeexmpts_t(msg.sender, true);
        feeexmpts_t(address(this), true);
        feeexmpts_t(address(0xdead), true);
        feeexmpts_t(marketingWallet, true);

        txexmptl_imit(msg.sender, true);
        txexmptl_imit(address(this), true);
        txexmptl_imit(address(0xdead), true);
        txexmptl_imit(marketingWallet, true);
     ...
     */
    function remLmts() external onlyOwner {
        limitsEnabled = false;
     ...
     */
    function mktwal_etSet(address newMktWal) external onlyOwner {
     ...
     */
    function devWlletS_et(address newDevWal) external onlyOwner {
