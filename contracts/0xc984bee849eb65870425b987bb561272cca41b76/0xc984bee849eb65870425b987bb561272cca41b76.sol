...
contract HOPO_OPEN_TRADING_IN_48h {
    string public constant NAME = "HOPO open trading in 48h";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7222000000 * (10 ** uint256(DECIMALS));
