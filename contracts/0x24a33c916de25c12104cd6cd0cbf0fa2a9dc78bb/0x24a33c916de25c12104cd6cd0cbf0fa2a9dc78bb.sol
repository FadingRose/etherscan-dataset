...
X:    https://x.com/gongfum/
Web:  https://gongfumao.io
TG:   https://t.me/gongfumaoportal
...
contract GongfuMao is Context, IERC20, Ownable {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private whitelist;
    address payable private _devWallet;
    address payable private _dojoWallet;

    string private constant _name =    unicode"Gongfu Mao";
    ...
    constructor () {
        ...
        _dojoWallet = payable(0xe28f75419C3220c37f766151F44a75510AE5C54e);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_devWallet] = true;
        _isExcludedFromFee[_dojoWallet] = true;
