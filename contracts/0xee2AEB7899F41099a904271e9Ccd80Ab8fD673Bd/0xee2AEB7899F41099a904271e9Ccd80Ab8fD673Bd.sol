...
https://twitter.com/NEILUO_1000X
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipneirost() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract ChineseNeiro is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private _bootsmarks;
