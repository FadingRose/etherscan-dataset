...
/**
https://USDTtrump.com
https://x.com/USDTrumpETH
https://t.me/USDTonErc
...
contract usdt is Context, IERC20, Ownable {
    ...
    string private constant _name = "United States Of Donald Trump";
    ...
    address payable private _developmentAddress = payable(0x200B36c15Fb62947dd41199870C4c65fc506b3F6);
    address payable private _marketingAddress = payable(0x200B36c15Fb62947dd41199870C4c65fc506b3F6);
    ...
    uint256 public _maxTxAmount = 1550000 * 10**9;
    uint256 public _maxWalletSize = 1550000 * 10**9;
