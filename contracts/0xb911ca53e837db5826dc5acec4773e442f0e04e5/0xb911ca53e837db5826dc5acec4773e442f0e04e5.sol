...
rumours of $MASK (metamask) & $OPEN (opensea) launching Q3 2024, per @downsin
...
contract openmask is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OpenMask";
    string private constant _symbol = unicode"OPENMASK ";
