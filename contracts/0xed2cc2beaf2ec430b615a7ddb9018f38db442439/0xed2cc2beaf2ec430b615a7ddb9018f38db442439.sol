...
/* 
    website  - https://pimppepe.fun
    twitter  - https://x.com/PimppepeWang
    telegram - https://t.me/pimppepeERC
*/
...
contract PIMPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PIMP PEPE";
    string private constant _symbol = unicode"PIMPE";

    uint256 private _yeq = 77;
    uint256 private _cvu = 35;
    ...
    constructor() {
        _dsfzxc = payable(0x783160662AA1d6E7658Edf61218Bb6a0deeF613e);
    ...
    function createPimpe() external onlyOwner {
    ...
    function enablePimpe() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
