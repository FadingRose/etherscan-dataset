...
// File: contracts/DropsGovernor.sol
...
contract DROPSDAO {
    ...
    uint256 public constant PROPOSAL_TIME_LIMIT = 7 days;
    ...
    function vote(uint256 proposalId, bool voteYes) external {
        ...
        require(block.timestamp <= proposal.createdAt + PROPOSAL_TIME_LIMIT, "Voting period has ended");
    ...
    function executeProposal(uint256 proposalId) external {
        ...
        require(!proposal.executed, "Proposal already executed");
        require(!proposal.canceled, "Proposal canceled");
        require(block.timestamp <= proposal.createdAt + PROPOSAL_TIME_LIMIT, "Proposal execution period has ended");
    ...
    function cancelProposal(uint256 proposalId) external {
        Proposal storage proposal = proposals[proposalId];
        require(block.timestamp > proposal.createdAt + PROPOSAL_TIME_LIMIT, "Proposal time limit not reached");
        require(!proposal.executed, "Proposal already executed");
