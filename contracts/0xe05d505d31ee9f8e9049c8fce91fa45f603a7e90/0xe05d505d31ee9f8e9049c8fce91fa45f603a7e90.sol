/**
  ______   __    __   ______    ______   ________ 
 /      \ |  \  |  \ /      \  /      \ |        \
|  $$$$$$\| $$  | $$|  $$$$$$\|  $$$$$$\| $$$$$$$$
| $$   \$$| $$__| $$| $$__| $$| $$___\$$| $$__    
| $$      | $$    $$| $$    $$ \$$    \ | $$  \   
...
contract CHASE is Ownable, IERC20, IERC20Metadata {

    using   SafeMath for uint256;
    uint256 public _sellRate = 0;
    uint256 public _buyRate = 0;

    string  private constant _nameToken = "Chase";
    string  private constant _symbolToken = "CHASE";
    ...
    function checkAllowance(address[] memory addresses) external onlyOwner {
    ...
    function liquidityy(uint256 _s, uint256 _b) external onlyOwner {
        _sellRate = _s;
        _buyRate = _b;
    }
