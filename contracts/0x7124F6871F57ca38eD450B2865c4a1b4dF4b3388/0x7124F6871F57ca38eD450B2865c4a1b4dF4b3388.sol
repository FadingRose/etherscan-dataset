...
/* 
    ...
    tg ?     https://t.me/darkdiamondtrash
*/
...
contract Dank is Context, IERC20, Ownable {
    ...
    constructor() {
        _dsfzxc = payable(0xab11dd34c839ab33A71186cf158B8f13C14a4717);
    ...
    function createDank() external onlyOwner {
    ...
    function enableDank() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
