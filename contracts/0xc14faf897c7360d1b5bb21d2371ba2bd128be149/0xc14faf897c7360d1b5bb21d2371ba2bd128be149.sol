...
https://t.me/deadbidenportal

https://x.com/skskskskrrttt/status/1815406036016345291
...
contract BDONE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet=payable(0xbA21184e2EE4623b73a70E3D002587Eb58c1FC2B);
    ...
    string private constant _name = unicode"BYE DONE";
    string private constant _symbol = unicode"BDONE";
