...
// https://t.me/darko_erc
// https://x.com/darko_erc
...
/* Main Contract */
contract DARKO is ERC20, Ownable {
    ...
    bool public twxqSwapEnabled = false;
    ...
    constructor() ERC20("Donnie Darko", "DARKO") {
        ...
        marketWallet = address(0x02e339ecaB4d59eb8af4B2155496398746704029);
        devWallet = address(0xe538A78C4D7F8546A966DA07FB91369Ec3906152);
        ...
        maxTransaction = 10_000 * 1e18; 
        maxWalletSize = 10_000 * 1e18; 
    ...
    function updatetwxqSwapEnabled(bool enabled) external onlyOwner {
        twxqSwapEnabled = enabled;
    }
