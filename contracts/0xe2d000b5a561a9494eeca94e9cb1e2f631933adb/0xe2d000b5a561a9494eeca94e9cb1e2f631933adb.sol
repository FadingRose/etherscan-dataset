...
contract TRUMPMAX is ERC20 {
    ...
    constructor() ERC20("TrumpMax", "TRUMPMAX") {
        _mint(msg.sender, 100000000000 * 10 ** decimals); //100 Billion Minted
        taxWallet = 0x61647B0F6666C51764F1D299b4eb42346Df11265;
...
// This will not be a permanent contract as it is for testing purposes only. Please DYOR.
