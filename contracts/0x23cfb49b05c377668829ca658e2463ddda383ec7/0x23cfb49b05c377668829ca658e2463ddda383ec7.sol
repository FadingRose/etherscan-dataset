...
contract HOPO_PIPO_LAUNCH_TOMORROW {
    string public constant NAME = "HOPO PIPO launch in 24h";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 6000000000 * (10 ** uint256(DECIMALS));
