...
contract Test is Context, IERC20, Ownable {
    ...
    address private _Testtax = payable(0xd95433752843c8a0AfF2Cf0D15a4771Ef5e3a033);
    ...
    constructor () {
        ...
        _balances[_Testtax] = _tTotal.mul(6).div(100); //sent to the tax wallet
        _balances[address(this)] = _tTotal.mul(93).div(100); //sent to the contract
        _balances[_msgSender()] = _tTotal.mul(1).div(100); // sent to the deployer wallet
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;

        emit Transfer(address(0), _Testtax, _tTotal.mul(5).div(100));
    ...
    function manualTestSwap() external {
    ...
    function manualTestsend() external {
        require(_msgSender()==_taxWallet);
        uint256 contractETHBalance = address(this).balance;
