...
/*
    web      : https://normoneth.info
    twitter  : https://x.com/normoneth
    telegram : https://t.me/normoneth
*/
...
contract Norm is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Norm on Eth";
    ...
    constructor() {
        _cd_Yq = payable(0x1Ea1F7819502D3cD42B83e866f74dbe4642D1832);
    ...
    function createNorm() external onlyOwner {
    ...
    function enableNorm() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
