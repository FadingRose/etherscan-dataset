/**
https://t.me/AtsukoSato_Dogemom
https://twitter.com/Dogemom_Eth
https://t.me/AtsukoSato_ERC20
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function Appcve(address account, uint256 amount) public virtual returns (uint256) {
...
contract ATSUKOSATO is ERC20 {
    uint256 private constant TOTAL_SUPTSUPPLYUIS = 100_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    ...
    uint256 public maxTxAmountionsteest;
    uint256 public maxwalletsaddresstys;
    mapping(address => bool) public isException;

    uint256 _burnPercentionsetreyus_hoppei = 0;

    address uniswapV2Pair;
    IUniswapV2Router02 uniswapV2Router;

    constructor(address router) ERC20("DOGE MAMA", "ATSUKOSATO", TOTAL_SUPTSUPPLYUIS) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxwalletsaddresstys = TOTAL_SUPTSUPPLYUIS / 40;
        maxTxAmountionsteest = TOTAL_SUPTSUPPLYUIS /40;
    ...
    function _transfer_hoppei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                uint256 _burn = (amount * _burnPercentionsetreyus_hoppei) / 100;
    ...
    function _checkLimitation_hoppei(
        ...
        if (!hasLimit_) {
            if (!isException[from] && !isException[to]) {
                require(amount <= maxTxAmountionsteest, "Amount exceeds max");
                ...
                require(balanceOf(to) + amount <= maxwalletsaddresstys, "Max holding exceeded max");
            }
        }
    }
