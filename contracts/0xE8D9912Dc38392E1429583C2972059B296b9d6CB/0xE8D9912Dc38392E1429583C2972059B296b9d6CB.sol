...
contract Frinkcoin is ERC20, Ownable {
    ...
    string private constant _name = "Frinkcoin";
    string private constant _symbol = "FRINKCOIN";

    uint256 public initialTotalSupply = 100000000 * 1e9;
    uint256 public maxTransactionAmount = 2000000 * 1e9;
    uint256 public maxWallet = 2000000 * 1e9;
    uint256 public swapTokensAtAmount = 1000000 * 1e9;
