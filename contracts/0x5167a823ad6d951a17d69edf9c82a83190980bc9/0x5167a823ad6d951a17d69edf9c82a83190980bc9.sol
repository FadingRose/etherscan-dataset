...
contract doggoesWOOF is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Woof", "WOOF") {
        ...
        marketingWallet = address(0x422b980DEcCB3aC00957a1e92C81eb8C9581E5C0); // marketingwallet
        devWallet = address(0x422b980DEcCB3aC00957a1e92C81eb8C9581E5C0); // devwallet
