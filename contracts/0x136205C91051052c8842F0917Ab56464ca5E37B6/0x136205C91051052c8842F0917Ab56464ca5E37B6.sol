...
interface ICrossDomainMessenger_0 {
...
interface IExponentialPriceOracle_0 {
...
// src/contracts/Miscellany/FraxFarmQuitCreditor/IL1CrossDomainMessenger.sol

interface IL1CrossDomainMessenger_0 {
    function MESSAGE_VERSION() external view returns (uint16);
...
// src/contracts/Miscellany/FraxFarmQuitCreditor/Imports.sol
...
interface IL1CrossDomainMessenger_1 {
    function MESSAGE_VERSION() external view returns (uint16);
...
interface ICrossDomainMessenger_1 {
    function MESSAGE_VERSION() external view returns (uint16);
...
interface IExponentialPriceOracle_1 {
    function getPrices() external view returns (bool _isBadData, uint256 _priceLow, uint256 _priceHigh);
...
contract L1QuitCreditorReceiverConverter_0 is ReentrancyGuard_1, OwnedV2_0 {
    // STATE VARIABLES
    // ===================================================

    /// @notice Fraxtal CrossDomainMessenger
    ICrossDomainMessenger_1 public messenger = ICrossDomainMessenger_1(0x4200000000000000000000000000000000000007);

    /// @notice Fraxtal CrossDomainMessenger
    address public quitCreditorAddress;

    /// @notice Token that the L1 USD credit is being exchanged for
    IERC20_1 public conversionToken;

    /// @notice How much conversion token to give for each 1e18 USD that was messaged over
    IExponentialPriceOracle_1 public conversionOracle;
    ...
    constructor(
        ...
        conversionToken = IERC20_1(_conversionToken);
        conversionOracle = IExponentialPriceOracle_1(_conversionOracle);
    }
    ...
    function processMessage(
        ...
        // Send out the tokens
        SafeERC20_0.safeTransfer(conversionToken, _recipient, _convTknOut);
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        SafeERC20_0.safeTransfer(IERC20_1(tokenAddress), msg.sender, tokenAmount);
    }
    ...
    function setConversionOracle(address _newConversionOracle) external onlyOwner {
        conversionOracle = IExponentialPriceOracle_1(_newConversionOracle);
    }
...
// File contracts/Staking/FraxFarmQuitCreditor_UniV3_FRAX_USDC.sol
...
// |                                                                  |
// ====================================================================
// =============== FraxFarmQuitCreditor_UniV3_FRAX_USDC ===============
// ====================================================================
...
contract FraxFarmQuitCreditor_UniV3_FRAX_USDC_0 is ReentrancyGuard_1, OwnedV2_0 {
    // STATE VARIABLES
    // ===================================================
    ...
    IERC20_1 public fxsToken = IERC20_1(0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0);
    ...
    IL1CrossDomainMessenger_1 public l1CrossDomainMessenger =
        IL1CrossDomainMessenger_1(0x126bcc31Bc076B3d515f60FBC81FddE0B0d542Ed);
    ...
    constructor(address _owner, address _fxtlL1QuitCdRecCvtrAddr) OwnedV2_0(_owner) {
    ...
    function ping() external payable nonReentrant {
        ...
        l1CrossDomainMessenger.sendMessage{ value: msg.value }(
            ...
            abi.encodeCall(L1QuitCreditorReceiverConverter_0.receivePing, (block.timestamp)),
            minGasLimit
        );
    }
    ...
    function exitAllForCredit(
        ...
        SafeERC20_0.safeTransfer(fxsToken, msg.sender, fxsToken.balanceOf(address(this)));

        // Send the message to Fraxtal via the L1CrossDomainMessenger
        l1CrossDomainMessenger.sendMessage{ value: msg.value }(
            fxtlL1QuitCdRecCvtrAddr,
            abi.encodeCall(
                L1QuitCreditorReceiverConverter_0.processMessage,
...
/// @notice Accepts an L1 message from a FraxFarmQuitCreditor_XXX and converts the provided USD value to another token
contract L1QuitCreditorReceiverConverter_1 is ReentrancyGuard_0, OwnedV2_1 {
    // STATE VARIABLES
    // ===================================================

    /// @notice Fraxtal CrossDomainMessenger
    ICrossDomainMessenger_0 public messenger = ICrossDomainMessenger_0(0x4200000000000000000000000000000000000007);

    /// @notice Fraxtal CrossDomainMessenger
    address public quitCreditorAddress;

    /// @notice Token that the L1 USD credit is being exchanged for
    IERC20_0 public conversionToken;
    ...
    constructor(
        ...
        quitCreditorAddress = _quitCreditor;
        conversionToken = IERC20_0(_conversionToken);
    ...
    function receivePing(address _pinger, uint256 _sourceTs) external nonReentrant {
        // Make sure that the caller on L1 was the FraxFarmQuitCreditor_XXX
        if (messenger.xDomainMessageSender() != quitCreditorAddress) revert BadXDomainMessageSender();
    ...
    function processMessage(
        ...
        // Send out the tokens
        SafeERC20_1.safeTransfer(conversionToken, _recipient, _convTknOut);
    ...
    /// @param tokenAmount The amount of the token to recover
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        SafeERC20_1.safeTransfer(IERC20_0(tokenAddress), msg.sender, tokenAmount);
    }

    /// @notice Set the price of the conversion token, in E18 USD
    /// @param _newConversionPrice The new conversion price
    function setConversionOracle(uint256 _newConversionPrice) external onlyOwner {
...
// src/contracts/Miscellany/FraxFarmQuitCreditor/FraxFarmQuitCreditor_UniV3_FRAX_USDC.sol
...
/// @notice Exits a Frax UniV3 farm and credits a USD value to a special contract on Fraxtal, which can be converted there into another token, such as an FXB
/// @dev Make sure to enable this contract as a migrator first on the target farm
contract FraxFarmQuitCreditor_UniV3_FRAX_USDC_1 is ReentrancyGuard_0, OwnedV2_1 {
    // STATE VARIABLES
    // ===================================================
    ...
    /// @notice FXS reward tokens
    IERC20_0 public fxsToken = IERC20_0(0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0);
    ...
    /// @notice L1CrossDomainMessenger for sending messages to Fraxtal
    IL1CrossDomainMessenger_0 public l1CrossDomainMessenger =
        IL1CrossDomainMessenger_0(0x126bcc31Bc076B3d515f60FBC81FddE0B0d542Ed);
    ...
    /// @param _owner The owner of the contract
    /// @param _fxtlL1QuitCdRecCvtrAddr On Fraxtal. Accepts a cross-chain message and converts the USD value to another specified token
    constructor(address _owner, address _fxtlL1QuitCdRecCvtrAddr) OwnedV2_1(_owner) {
        fxtlL1QuitCdRecCvtrAddr = _fxtlL1QuitCdRecCvtrAddr;
    }
    ...
    /// @notice Used to test connectivity. Sends a dummy message to Fraxtal
    /// @dev TODO: Use value = 0?
    function ping() external payable nonReentrant {
        // Send the message to Fraxtal via the L1CrossDomainMessenger
        l1CrossDomainMessenger.sendMessage{ value: msg.value }(
            fxtlL1QuitCdRecCvtrAddr,
            abi.encodeCall(L1QuitCreditorReceiverConverter_1.receivePing, (msg.sender, block.timestamp)),
            minGasLimit
        );
    }
    ...
    function exitAllForCredit(
        ...
        // All reward tokens collected during the migration are sent to the user.
        SafeERC20_1.safeTransfer(fxsToken, msg.sender, fxsToken.balanceOf(address(this)));

        // Send the message to Fraxtal via the L1CrossDomainMessenger
        l1CrossDomainMessenger.sendMessage{ value: msg.value }(
            fxtlL1QuitCdRecCvtrAddr,
            abi.encodeCall(
                L1QuitCreditorReceiverConverter_1.processMessage,
                (msg.sender, _recipientOnFraxtal, _usdCredit)
            ),
            minGasLimit
        );
