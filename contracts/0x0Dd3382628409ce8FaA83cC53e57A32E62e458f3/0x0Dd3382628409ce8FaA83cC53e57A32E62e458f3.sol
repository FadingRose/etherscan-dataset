...
/**
工ドモンド本田とは、CAPCOMの対戦格闘ゲ一ムГストリ一トフアイタ一 I」およびシリ一ズ作に登場するキャラクタ一で.
Edmond Honda will be released as a meme character symbol on Ethereum, which is an experimental revolution. 

Web: https://ehonda.xyz
X: https://x.com/ehonda_erc
Tg: https://t.me/ehonda_portal
**/
...
contract EHonda is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Edmon Honda";
    string private constant _symbol = unicode"EHonda";
    ...
    constructor() {
        _taxWallet = payable(0x7F3455E7505fd8Be28d9507E92814681Ee97f44B);
