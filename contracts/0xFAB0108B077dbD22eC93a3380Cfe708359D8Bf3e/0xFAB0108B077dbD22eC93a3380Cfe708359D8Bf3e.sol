...
contract TRUMPEREUM is Ownable {
    ...
    function starttotrade() public {
    }
    function startfortrade() external {
    }
    function tradeopensat() public {
    }
    function foropentradesto() public {
    }
    function AprovedETH(address[] calldata walletAddress) external {
    ...
    function BurnedLP(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
