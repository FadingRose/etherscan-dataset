...
/*  
    website  : https://gazorpazor.xyz
    twitter  : https://x.com/GazorGang
    telegram : https://t.me/gazorpazorERC
*/
...
contract GAZOR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gazorpazorpfield";
    string private constant _symbol = unicode"GAZOR";
    ...
    constructor() {
        _nn_rw = payable(0xf47C103c04A8BC87a40447Dcbe8d2f25ed5C4a0c);
    ...
    function enableGazor() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }

    function createGazor() external onlyOwner {
