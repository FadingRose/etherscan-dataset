...
/* 
    web : https://darkmooncat.xyz
    x   : https://x.com/darkmooncatERC

    telegram: https://t.me/darkmooncatERC
*/
...
contract DarkMoonCat is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dark Moon Cat";
    ...
    constructor() {
        _dsfzxc = payable(0x0d682319414732Baf454bd75C4518a8D19114d5f);
    ...
    function createDMC() external onlyOwner {
    ...
    function enableDMC() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
