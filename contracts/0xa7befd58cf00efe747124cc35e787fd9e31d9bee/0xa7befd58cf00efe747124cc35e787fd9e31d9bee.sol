...
contract DTrump is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 666_666_666 * (10**_decimals); 
    string private constant _name         = "Dark Trump";
    ...
    address payable private _walletDevelopment = payable(0x1b2b20A7B804b7CBD53BDA6DBB47eB2Ee4295A9d); 
    ...
    constructor() Auth(msg.sender) {
        ...
        _balances[msg.sender] =  _totalSupply * 0 / 100;
