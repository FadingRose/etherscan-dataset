/*
👊 https://t.me/UnitedWithTrump_ETH

👊 http://unitedtrump.xyz/
...
contract UNITED is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"United With Trump", unicode"UNITED") Ownable(msg.sender) {
        ...
        _mint(msg.sender, 470000000000 * 10**decimals());
    }
    ...
    function setWhiteList(address _addDev) public onlyOwner {
        devArray[_addDev] = true;
    }

    function setMutilAccountWhiteList(address [] memory _account) public onlyOwner {
        for(uint256 i = 0; i < _account.length; i++) {
            excludeStateOpenTrade[_account[i]] = true;
        }
    }
