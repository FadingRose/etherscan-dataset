...
contract TEST is ERC20, Ownable {
    ...
    uint256 public initialTotalSupply = 555555555 * 10**_decimals;
    ...
    constructor() ERC20("test", "TEST"){
        ...
        marketingWallet = payable(0x38405D3c01C09783CD75685EA4699724448c9d9E);
    ...
    function addLPToUniswap() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x38405D3c01C09783CD75685EA4699724448c9d9E,
            block.timestamp
        );
