...
/*
$GAT is not just a cat, he's God. $GAT is on a mission to answer a dysfunctional family's problems, but he must overcome his hatred for humans and defeat Devilcat before he can return to Heaven.

Website :   https://www.godcatoneth.xyz
Telegram : https://t.me/gat_eth
Twitter :     https://x.com/gat_erc
*/
...
contract GAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"God Cat";
    string private constant _symbol = unicode"GAT";
    ...
    constructor() {
        _doWallet = payable(0x7158AC378c1AC7F8527AB1fDE05A78816e454025);
