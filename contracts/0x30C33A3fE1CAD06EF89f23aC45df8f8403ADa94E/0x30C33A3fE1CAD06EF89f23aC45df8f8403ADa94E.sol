...
contract FraxFarmQuitCreditor_UniV3_0 is ReentrancyGuard_1, OwnedV2_0 {
    // STATE VARIABLES
    // ===================================================
...
// src/contracts/Miscellany/FraxFarmQuitCreditor/FraxFarmQuitCreditor_UniV3.sol
...
/// @notice Exits a Frax UniV3 farm and credits a USD value to a special contract on Fraxtal, which can be converted there into another token, such as an FXB
/// @dev Make sure to enable this contract as a migrator first on the target farm
contract FraxFarmQuitCreditor_UniV3_1 is ReentrancyGuard_0, OwnedV2_1 {
    // STATE VARIABLES
    // ===================================================
    ...
    constructor(address _owner, address _fxtlL1QuitCdRecCvtrAddr, address _farm) OwnedV2_1(_owner) {
        fxtlL1QuitCdRecCvtrAddr = _fxtlL1QuitCdRecCvtrAddr;
    ...
    function _withdrawLogic(uint256 _tknId, uint256 _liquidity) internal returns (uint256[4] memory _tokensOutOne) {
        ...
        // Remove the principal
        {
            ...
            // Prepare to collect the principal
            ...
            // Note the collected principals. Will be kept in this contract for later recovery
        ...
        )
    {
        ...
        SafeERC20_1.safeTransfer(fxsToken, msg.sender, _tokensOut[0]);
    ...
    function collectAllTkn0AndTkn1() external onlyOwner returns (uint256[2] memory _tknsOut) {
        ...
        // Send the tokens
        SafeERC20_1.safeTransfer(token0, msg.sender, _tknsOut[0]);
        SafeERC20_1.safeTransfer(token1, msg.sender, _tknsOut[1]);
    }
    ...
    /// @param tokenAmount The amount of the token to recover
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        SafeERC20_1.safeTransfer(IERC20Metadata(tokenAddress), msg.sender, tokenAmount);
    }
