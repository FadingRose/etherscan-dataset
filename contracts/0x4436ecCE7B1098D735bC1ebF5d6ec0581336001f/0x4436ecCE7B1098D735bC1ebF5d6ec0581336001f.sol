...
contract PLANPresale is Ownable {
    IERC20 public token;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 100000000000000, 1722392957, 1722479357); //stage 1
        stages[2] = Stage(2, 15, 200000000000000, 1722479358, 1722565758); //stage 2
        stages[3] = Stage(3, 10, 300000000000000, 1725244158, 1727836158); //stage 3
        stages[4] = Stage(4, 5, 400000000000000, 1727836159, 1759372159); //stage 4
        currentStageId = 4;
    }
