...
/*  $DPROFILE dedicated to the Elon Musk's dark profile.

    TG: https://t.me/DPROFILE_ERC
...
contract DPROFILE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DARK PROFILE";
    string private constant _symbol = unicode"DPROFILE";
    ...
    constructor () {
        _taxWallet = payable(0x365EeB90a6c0861F5eB81ad498B728507d769BBd);
