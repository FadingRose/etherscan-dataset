/*
Telegram: https://t.me/PAWSonETH
Website: http://pawscoin.vip
X: https://x.com/PAWSonETH
*/
...
contract PAWS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PAWS";
    ...
    constructor () {
        _taxWallet = payable(0x4bd21f8106d8A718c0fE76241a131F123D605720);
    ...
    function transferForeignToken(address _token) external {
        require(_token != address(this), "Can't let you take native token");
