...
contract HAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump's Hat";
    string private constant _symbol = unicode"HAT";
    uint256 public _maxTxAmount = 200_000_0 * 10**_decimals;
    uint256 public _maxWalletSize = 200_000_0 * 10**_decimals;
    uint256 public _taxSwapThreshold= 10_000_0 * 10**_decimals;
    uint256 public _maxTaxSwap= 50_000_0 * 10**_decimals;
