...
contract BULLFAN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal= 3_400_000_000 * 10**_decimals;
    string private constant _name = unicode"BULLFAN";
    string private constant _symbol = unicode"BULLFAN";
