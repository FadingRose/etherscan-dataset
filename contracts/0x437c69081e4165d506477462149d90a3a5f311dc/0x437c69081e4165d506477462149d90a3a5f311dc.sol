...
/*
 ...
 BBBBB     OOOOO     OOOOO     SSSSS  TTTTTTT        
 B    B   O     O   O     O   S          T 
 B    B   O     O   O     O   S          T
 BBBBB    O     O   O     O    SSSS      T  
 B    B   O     O   O     O        S     T
 B    B   O     O   O     O        S     T  
 BBBBBB    OOOOO     OOOOO    SSSSS      T                  

 Relaunch coming July 29th
 https://x.com/theboostcoin
...
pragma solidity ^0.6.12;
    ...
    contract BoostToken is Context, IERC20, Ownable {
        ...
        uint256 private _maxWalletSize = 1000000000 * 10**18;
        ...
        constructor (address payable devWalletAddress, address payable marketingWalletAddress, address payable dipWalletAddress, address payable marketingWalletAddress2) public {
            ...
            _isExcludedFromFee[devWalletAddress];
            _isExcludedFromFee[marketingWalletAddress];
            _taxFee = 40;
