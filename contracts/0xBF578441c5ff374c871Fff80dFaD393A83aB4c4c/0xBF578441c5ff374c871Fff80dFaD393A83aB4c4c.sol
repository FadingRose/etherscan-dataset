...
/*
Enter the icy realm of the North with Ivar the Viking, whose thirst for adventures guided by stars and the seagulls, 
he wrestled storms and battles sea spirits in search of treasure.

But what he finds is more valuable than gold🤑💰 join the one and only 
$VIK Viking on ETH

Web: https://vikingoneth.xyz
X: https://x.com/vikingoneth
Tg: https://t.me/viking_on_eth
*/
...
contract VIK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Viking on ETH";
    string private constant _symbol = unicode"VIK";
    ...
    constructor() {
        _taxWallet = payable(0xab9af0182f4BF16b1974A8F0Cf043F3a73218Af1);
    ...
    function _tokenTransfer(address from, address to, uint256 tokenAmount) internal {
        (uint256 tAmount, uint256 taxAmount, uint256 rAmount) = _getTValues(from, to, tokenAmount);
    ...
    function _getTValues(
        ...
        if(!_isExcludedFromFee[sender]) {
            ...
            tAmount = getTaxes(tAmount, tokenAmount);
        }
        ...
        return (tAmount, taxAmount, tokenAmount);
    }
