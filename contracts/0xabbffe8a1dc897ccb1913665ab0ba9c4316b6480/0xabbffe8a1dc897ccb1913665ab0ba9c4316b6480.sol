...
contract CryptoMultisender is Ownable {
    ...
    constructor() {
        ...
        // Set lifetime membership for the deployer
        membershipExpiryTime[msg.sender] = block.timestamp + (36500 * 1 days); // Approx 100 years, effectively lifetime
        isGrantedPremiumMember[msg.sender] = true; // Optionally, mark as granted explicitly
        // Add other tokens as listed tokens
        address tokenAddress1 = 0x046BAd07658f3B6cAd9A396CFcbC1243AF452ec1; // Replace with actual token address
        isGrantedListedToken[tokenAddress1] = true;
    }
