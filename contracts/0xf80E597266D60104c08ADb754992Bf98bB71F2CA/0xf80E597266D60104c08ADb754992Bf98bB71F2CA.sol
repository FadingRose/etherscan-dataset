...
/*
From the shadows, we rise. Unyielding, unstoppable, and ready to reclaim greatness. This is Black MAGA. $BMAGA

Website :   https://blackmaga.live
Telegram : https://t.me/bmaga_erc20
Twitter :     https://x.com/bmaga_erc20
*/
...
contract BMAGA is ERC20, Ownable {
    ...
    string private constant _name = "Black Maga";
    ...
    function openBmaga() external onlyOwner() {
        tradingOpen = true;
    }
