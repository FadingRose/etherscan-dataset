...
╚═╝     ╚═╝  ╚═╝╚═╝      ╚═════╝ 
 ...
 <------------------------------------------------------------>
  |   WEBSITE     : https://papotokeneth.com/                |
  |   Instagram   : https://www.instagram.com/papocoineth    | 
  |   Tiktok      : www.tiktok.com/@papocoin                 | 
  |   Telegram    : https://t.me/papocoinoneth               |
  |   X-(Twitter) : https://x.com/papocoineth                |
 <------------------------------------------------------------>
...
contract PAPO is Context , IERC20, Ownable {
    ...
    constructor () {
        _taxWallet = payable(0x44bC21334eA4D1625A1Fa6217BF1E946c05E2B76);
