...
abstract contract Ownable is Context {
     ...
     * `onlyOwner` functions. Can only be called by tlhe current owner.
     *
     * NOTE: Renouncing ownership will leave the contract without an owner,
     * thereby disabling any functionality that is ony available to the owner.
     */
...
contract AdhdCoin is ERC20, Ownable {
