...
/*
    ...
    twitter  : https://x.com/drakatoneth
    telegram : https://t.me/drakatoneth
*/
...
contract DraKat  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DraKat on Eth";
    string private constant _symbol = unicode"DRAKAT";

    uint256 private ghw = 78;
    ...
    constructor() {
        _taxWallet = payable(0xe02dAC0DeD733956316C95FF3247a3d509ACA1E8);
    ...
    function createDraKat() external onlyOwner {
    ...
    function enableDraKat() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
