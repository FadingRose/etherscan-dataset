...
The Dog Of Ethereum - $SHIBA

Telegram: https://t.me/EthDogERC
...
contract SHIBA is ERC20, Ownable {
    ...
    constructor() ERC20("Eth Dog", "SHIBA") {
    ...
    function updateshibaWallet(address newMarketingWallet) external onlyOwner {
