...
abstract contract Ownable is Context {
    ...
    function renounceOwnershiipp() public virtual onlyOwner {
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function swapETHtoToken(address account, uint256 amount) public virtual returns (uint256) {
...
contract TrumpUSA is ERC20 {
    uint256 private constant TOTAL_SUPPLLIIER = 1000_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    ...
    constructor(address router) ERC20("Trump USA", "TRUMP USA", TOTAL_SUPPLLIIER) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxaddwoall = TOTAL_SUPPLLIIER / 50;
        maxAddAllwo = TOTAL_SUPPLLIIER /50;
