...
$wof stands as a reminder that Kabosu is still watching 
over us, her spirit barking from the heavens. 
This token is dedicated to honoring her memory 
and ensuring that her legacy lives 
on in the hearts of those who remember. 

 W: https://woferc20.com
 T: https://t.me/woferc20
...
contract wof is ERC20, Ownable {
    ...
    constructor () ERC20("the world of kabosu", "wof") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x6bc38Abdc152a100392965c10dc5A5371e320F23);
        ...
        feeReceiver = 0xd581d05f34e501f6a1B0C61107Bd9Ea3c497310A;
        ...
        _mintOnce(owner(), 111e6 * (10 ** decimals()));
