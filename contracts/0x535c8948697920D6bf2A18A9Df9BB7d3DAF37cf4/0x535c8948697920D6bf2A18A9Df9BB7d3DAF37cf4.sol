/**
Web : https://tonyoneth.vip
TG :    https://t.me/tony_erc
X :      https://x.com/tony_erc
**/
...
contract TONY is Context, IERC20, Ownable {
    ...
    constructor() {
        _taxWallet = payable(0x677EC42a22351eAc9AEa989e7B81d6FcaFe34BC5);
    ...
    function wakeupTony() external onlyOwner { 
    ...
    function runTony() external onlyOwner {
