...
contract HOPO_PIPO_HOPO_PIPO_HOPO_PIPO {
    string public constant NAME = "HOPO PIPO HOPO PIPO HOPO PIPO";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7666666000 * (10 ** uint256(DECIMALS));
