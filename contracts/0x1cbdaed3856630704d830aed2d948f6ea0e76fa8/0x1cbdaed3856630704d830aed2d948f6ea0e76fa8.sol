...
contract HOPO_GETS_A_MASSAGE_AFTER_PROMOTING_THE_TOKEN {
    string public constant NAME = "Hopo gets a massage after promoting the token";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7444000000 * (10 ** uint256(DECIMALS));
