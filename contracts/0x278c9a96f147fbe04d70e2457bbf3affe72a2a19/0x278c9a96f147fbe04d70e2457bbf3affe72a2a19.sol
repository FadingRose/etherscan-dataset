...
Telegram: https://t.me/MakeMadApesGreatAgain

Twitter: https://twitter.com/madapescall/status/1818286556811280484
*/
...
contract T1T4N is ERC20, Ownable {
    ...
    string private constant _name = "Make Mad Apes Great Again";
    string private constant _symbol = "T1T4N";
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 15 && _sellFee <= 15, "Fees cannot exceed 15%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
