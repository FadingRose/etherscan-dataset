...
/**
Introducing Blue Screen Of Death

Inspired by the infamous Blue Screen of Death (BSOD) error in Windows. $BSOD capitalizes on the widespread recognition and frustration of the BSOD error. :warning:

Web:   https://www.bluescreenofdeath.pro
TG:       https://t.me/bluescreen_death
X:          https://twitter.com/bsod_erc
  */
...
contract BSOD is Context, IERC20, Ownable {
    ...
    uint256 private constant _initialBuyTax = 45;
    uint256 private constant _initialSellTax = 45;
    ...
    constructor() {
        _feeEcos = payable(0xa07678C70565BCE5F82161C125fD98E82ED44B6A);
