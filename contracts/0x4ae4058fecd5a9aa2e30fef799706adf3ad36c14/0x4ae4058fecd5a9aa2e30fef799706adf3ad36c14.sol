...
/*
    Josh Shapiro - President (or Vice President)!

    https://t.me/Shapiro_token

    https://x.com/Shapiro_token 
    
    https://joshshapiroerc.xyz/ 
*/
...
contract SHAPIRO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Josh Shapiro";
    string private constant _symbol = unicode"SHAPIRO";
