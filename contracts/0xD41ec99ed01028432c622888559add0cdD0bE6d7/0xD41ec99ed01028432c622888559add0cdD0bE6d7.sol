...
contract KEKS is Context, IERC20, Ownable {
...
uint8 private constant _decimals = 9;
    ...
    string private constant _name = unicode"KEKS";
    string private constant _symbol = unicode"KEKS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 taxAmount=0;
        if (from != owner() && to != owner() && to != _taxWallet && from != address(this) && to != address(this)) {
...
uint256 contractTokenBalance = balanceOf(address(this));
    ...
    function setFee(uint buyFee) external onlyOwner {
