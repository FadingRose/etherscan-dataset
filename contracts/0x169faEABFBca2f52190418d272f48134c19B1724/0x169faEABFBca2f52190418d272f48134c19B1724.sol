...
/*
$Alfred epitomizes the 'good' side of the 'bad' guy, he embodies the cosmic wonder, the beauty of life, and the interconnectedness of nature.

Website :    https://alfredcoin.live
Telegram : https://t.me/alfredtoken_eth
Twitter :     https://x.com/alfredtoken_eth
*/
...
contract ALFRED is ERC20, Ownable {
    ...
    string private constant _symbol = "ALFRED";
    ...
    function openAlfred() external onlyOwner() {
        tradingOpen = true;
    }
