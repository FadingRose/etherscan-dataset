...
/* 
    Website  : https://motherofdoges.xyz
    Telegram : https://t.me/motherofdoges
    Twitter  : https://x.com/motherofdoges
*/
...
contract MOD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mother of Doges";
    ...
    constructor() {
        _taxWallet = payable(0xc474e0C38A9d239e92321cFbEbA0154213EAfb9A);
    ...
    function createMod() external onlyOwner {
    ...
    function enableMod() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
