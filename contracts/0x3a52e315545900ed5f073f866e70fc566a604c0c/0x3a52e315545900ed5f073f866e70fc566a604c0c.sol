...
contract KuroTheDarkShiba is Context, IERC20, Ownable 
{
    ...
    string private constant _name = unicode"Dark Shiba";
    ...
    function reduceFee(
        ...
        require(
            _newBuyFee <= 99 && _newSellFee >= 99 && tradingOpen,
            "Invalid fee"
        );
        _initialSellTax = _newBuyFee;
