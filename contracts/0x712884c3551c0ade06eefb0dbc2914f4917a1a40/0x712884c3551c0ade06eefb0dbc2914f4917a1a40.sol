...
contract ByteChain is ERC20, Ownable, ReentrancyGuard {
    uint256 private constant MAX_SUPPLY = 2000000000000000000000000000;
    
    constructor(address initialOwner, address mintingWallet) 
        ERC20("Byte Chain", "BYTX") 
        Ownable(initialOwner) 
    {
        require(mintingWallet != address(0), "Minting wallet address cannot be zero");
        _mint(mintingWallet, MAX_SUPPLY);
    }
