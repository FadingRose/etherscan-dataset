...
// File: verified-sources/0x146F3582EBE45c46B2f88fB71681fA582BA53A79/sources/src/Olympe.sol
...
contract Olympe is ERC20, Ownable {
    //-------------------------------------------------------------------------
    // Errors
    //-------------------------------------------------------------------------
    ...
    uint private constant _TAX_INTERVAL = 3 minutes;
    uint private constant MAX_TAX_TIME = 120 minutes;
    ...
    constructor(
        ...
        address newOwner
    ) ERC20("Olympe", "OLYMPE") Ownable(newOwner) {
    ...
    function updateMarketingWallet(address _marketingwallet) external {
        ...
        if (_marketingwallet == address(0)) revert _InvalidValue();
