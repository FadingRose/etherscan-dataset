...
contract Token {
    ...
    string public constant name = "Bitvizy Token";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "BTVZ";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint256 public totalSupply = 10_000_000_000e18; // 10 billion Token
     ...
     * @param account The initial account to grant all the token
     */
    ...
    function transferFrom(address src, address dst, uint256 rawAmount) external returns (bool) {
        ...
        if (spender != src && spenderAllowance != type(uint256).max) {
            uint256 newAllowance = spenderAllowance.sub(amount, "Token::transferFrom: transfer amount exceeds spender allowance");
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balances[delegator]; // balance of underlying Token tokens (not scaled);
    ...
    function _transferTokens(address src, address dst, uint256 amount) internal {
        ...
        balances[src] = balances[src].sub(amount, "Token::_transferTokens: transfer amount exceeds balance");
