...
contract AlphaChainToken is ERC20, Ownable {
	using SafeMath for uint256;
	...
	constructor() ERC20('AlphaChain Token', 'ALPHA') {
		...
		marketingWallet = payable(0x6588cA6D9446d76900261b3EFFEe93656C3D66b0); // set as marketing wallet
