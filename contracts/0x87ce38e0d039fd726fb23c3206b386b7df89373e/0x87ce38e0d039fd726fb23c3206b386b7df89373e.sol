...
contract $DARKPEI is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"$DARKPEI";
    ...
    constructor () {
        _taxWallet = payable(0xA1776BAB311Fd46908cDb99514e820C35B0b87eE);
