...
Godfather Of America | $DON

The Godfather Of America coin inspired by a strong version of leadership and vision 
for the future of America and crypto by Donald Trump. He, like a true godfather, 
cares for the greatness and well-being of every person with all his strength and inspired dedication. 

Be part of the future with Don Trump - the Godfather of all Americans and the most influential supporter 
of crypto enthusiasts.

Website: https://godfatherofamerica.vip
Twitter: https://x.com/DON_ERC20
Portal: https://t.me/GodfatherOfAmericaCoin
*/
...
contract GodfatherofAmerica is ERC20, Ownable {
    ...
    string private constant _name = "Godfather Of America";
    ...
    function SetFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 30 && _sellFee <= 35, "Fees cannot exceed 30%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
