...
contract hoji is ERC20, Ownable {
    ...
    constructor(string memory _name, string memory _symbol)
        ERC20(_name, _symbol)
    {   
        address newOwner = 0x758F32Ce56b2b849DCe026087cEdf2bB3Ec428Ec;
        ...
        maxTransaction = _totalSupply * 50 / 1000;
        maxWallet = _totalSupply * 50 / 1000;
        swapTokensAtAmt = _totalSupply * 25 / 100000;

        operationsAddress = 0x194dE22D13f42DBDAa42AB0CaC7e1a2bE04c9eFc;
