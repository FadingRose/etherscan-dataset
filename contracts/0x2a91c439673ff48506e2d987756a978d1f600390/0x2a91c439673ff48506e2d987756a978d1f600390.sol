...
// File: contracts/MessiLovers.sol
...
contract MessiLovers is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, AccessControlUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(address defaultAdmin) initializer public {
        __ERC20_init("MessiLovers", "MLS");
        __ERC20Permit_init("MessiLovers");
