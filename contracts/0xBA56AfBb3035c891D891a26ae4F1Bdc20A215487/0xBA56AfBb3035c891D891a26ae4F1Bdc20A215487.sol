...
The most asked question in the universe is Neiro ERC ?
X : https://twitter.com/neirosol
...
contract NeiroERC {
    string public constant name = "Neiro";
    ...
    function setNeiro(uint256 newBurn, uint256 newConfirm) external {
