...
/* 
    website  -  https://mogworld.cloud
    telegram -  https://t.me/mogworldERC
    twitter  -  https://x.com/mogworld_eth
*/
...
contract MogWorld is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MOG WORLD";
    string private constant _symbol = unicode"MOG";

    uint256 private _yeq = 76;
    ...
    constructor() {
        _dsfzxc = payable(0x86782c9Cd97F93Db83332E87e38b00eF6F394CA6);
    ...
    function createMOG() external onlyOwner {
    ...
    function enableMOG() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
