...
contract Phenx is ERC20, Ownable {
    ...
    bool public renoucePauseTrading = false;

    uint256 public launchedAt;
    uint256 public launchedAtTimestamp;
    uint256 public antiSnipingTime = 0 seconds;

    uint256 public buyTotalFees = 5; // 5%
    uint256 public buyMarketingFee = 3; // 3%
    uint256 public buyDevelopmentFee = 2; // 2%
    uint256 public buyLiquidityFee = 0;

    uint256 public sellTotalFees = 5; // 5%
    uint256 public sellMarketingFee = 2; // 2%
    uint256 public sellDevelopmentFee = 3; // 3%
    ...
    constructor() ERC20("PhenX", "PNX") {
        ...
        maxSwapTokensAtAmount = 9000 * 10 ** 9;

        operationsWallet = address(0x3270EcCA611f2eA69985542eb00E9F0bb651AfBD);
    ...
    function updateBuyFees(
        ...
        require(
            _marketingFee + _developmentFee + _liquidityFee <= 30,
            "Total fees must be less than 30 or equal to 30"
        );
    ...
    function pause() public onlyOwner {
        require(renoucePauseTrading == false, "Can not pause trading");
        limitsInEffect = false;
        tradingActive = false;
    }
    function _renoucePauseTrading() public onlyOwner {
        renoucePauseTrading = true;
    }
    ...
    function launch() public onlyOwner {
        ...
        antiSnipingTime = 30 seconds; // blocks 0/1
        tradingActive = true;
        swapEnabled = true;
        buyMarketingFee = 20; // lower slowly
        buyDevelopmentFee = 20;
        sellMarketingFee = 20;
        sellDevelopmentFee = 20;
        sellTotalFees =
            sellMarketingFee +
            sellDevelopmentFee +
            sellLiquidityFee;
