...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowanceKarris(
        address spender,
        uint256 addedValue
     ...
     * `subtractedValue`.
     */
    function decreaseAllowanceKarris(
        address spender,
...
abstract contract Ownable is Context {
     ...
     */
    function renounceOwnershipKarris() public virtual onlyOwner {
     ...
     */
    function transferOwnershipKarris(address newOwner) public virtual onlyOwner {
        require(
            newOwner != address(0),
...
contract KARRIS is ERC20, Ownable {
    ...
    constructor() ERC20("Kamela Karris", "KARRIS") {
        ...
        uint256 _buyMarketingTax = 17;
        uint256 _buyProjectTax = 0;

        uint256 _sellMarketingTax = 33;
        ...
        marketingWallet = address(0xE3Daa282AbB8aD2544be21Ab44ad1a0C731907df);
        ...
        transferOwnershipKarris(msg.sender);
     ...
     * @dev     onlyOwner.
     */
    function karrrisss() external onlyOwner {
        tradingEnabled = true;
     ...
     * @param newNum Base 1000, so 1% = 10
     */
    function setMaxWallets(uint256 newNum) external onlyOwner {
     ...
     */
    function changeMarketingWallets(address newWallet) external onlyOwner {
     ...
     */
    function changeProjectWallets(address newWallet) external onlyOwner {
