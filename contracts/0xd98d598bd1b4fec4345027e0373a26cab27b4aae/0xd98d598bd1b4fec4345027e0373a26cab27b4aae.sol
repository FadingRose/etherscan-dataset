...
contract MAGADUKES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Dukes of MAGA"; 
    string private constant _symbol = unicode"MAGADUKES";
