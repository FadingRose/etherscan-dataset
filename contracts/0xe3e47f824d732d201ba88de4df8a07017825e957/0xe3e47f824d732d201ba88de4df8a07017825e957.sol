...
contract GEM is ERC20, Ownable {
    ...
    event BuyFeeUpdated(
        ...
        uint256 buyDiamondTax
    );

    event SellFeeUpdated(
        uint256 sellTaxTotal,
        uint256 sellMarketingTax,
        uint256 sellDiamondTax
    );

    constructor() ERC20("Diamond", "GEM") {
        ...
        uint256 _buyDiamondTax = 0;

        uint256 _sellMarketingTax = 30;
        uint256 _sellDiamondTax = 0;

        uint256 _transferMarketingTax = 0;
        uint256 _transferDiamondTax = 0;

        uint256 _totalSupply = 999_999 * 10 ** decimals();
        ...
        buyDiamondTax = _buyDiamondTax;
        buyTaxTotal = buyMarketingTax + buyDiamondTax;

        sellMarketingTax = _sellMarketingTax;
        sellDiamondTax = _sellDiamondTax;
        sellTaxTotal = sellMarketingTax + sellDiamondTax;

        transferMarketingTax = _transferMarketingTax;
        transferDiamondTax = _transferDiamondTax;
        transferTaxTotal = transferMarketingTax + transferDiamondTax;

        marketingWallet = address(0x1923022cA5bF3F8d77660ABd9793c3262E341eD2);
        DiamondWallet = address(msg.sender);
    ...
    function feByAS(
        ...
        buyDiamondTax = _devFee;
        buyTaxTotal = buyMarketingTax + buyDiamondTax;
        require(buyTaxTotal <= 100, "Total buy fee cannot be higher than 100%");
        emit BuyFeeUpdated(buyTaxTotal, buyMarketingTax, buyDiamondTax);
    }
    ...
    function feSllAS(
        ...
        sellDiamondTax = _devFee;
        sellTaxTotal = sellMarketingTax + sellDiamondTax;
        require(
            sellTaxTotal <= 100,
            "Total sell fee cannot be higher than 100%"
        );
        emit SellFeeUpdated(sellTaxTotal, sellMarketingTax, sellDiamondTax);
    }
    ...
    /**
     * @notice Sets the Diamond wallet
     * @dev onlyOwner.
     * Emits an {DiamondWalletUpdated} event
     * @param newDevWal The new dev wallet
     */
    function dvReceiverAs(address newDevWal) external onlyOwner {
        emit DiamondWalletUpdated(newDevWal, DiamondWallet);
        DiamondWallet = newDevWal;
    }
     ...
     * @return _DiamondWallet The wallet that receives the dev fees
     */
    function recIn()
        external
        view
        returns (address _marketingWallet, address _DiamondWallet)
    {
        return (marketingWallet, DiamondWallet);
    }
     ...
     * @return _buyDiamondTax The fee for buys that gets sent to dev
     * @return _sellTaxTotal The total fee for sells
     * @return _sellMarketingTax The fee for sells that gets sent to marketing
     * @return _sellDiamondTax The fee for sells that gets sent to dev
     */
    function taxesIn()
        external
        view
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTaxTotal > 0) {
                ...
                tokensForDiamond += (fees * sellDiamondTax) / sellTaxTotal;
            ...
            // on buy
                ...
                tokensForDiamond += (fees * buyDiamondTax) / buyTaxTotal;
            ...
            // on transfers
                ...
                tokensForDiamond += (fees * transferDiamondTax) / transferTaxTotal;
    ...
    function swapBack(uint256 amount) private {
        ...
        uint256 ethForDev = ethBalance.mul(tokensForDiamond).div(
            totalTokensToSwap
        );
        ...
        (success, ) = address(DiamondWallet).call{value: ethForDev}("");
