...
[CTO] > Status: Ready for takeover.

Website (https://ctofindrbot.com/) || Twitter (https://x.com/CTOFindrBot) || Portal (https://t.me/ctofindrbot) || Bot (https://t.me/CTOFindr_bot)
*/
...
contract CTOBOT is ERC20, Ownable {
...
constructor() ERC20("CTO Findr Bot","FINDR")
    {
        ...
        treasury = address(0xF11f6Bd1eF83046CAb8d19E82C282E20d9Cdc1e8);
        dev = address(0x9307cF8cF4474cae4DD3E8fc49b3A769C5FE2D11);
    ...
    function updateFeeAmount(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
