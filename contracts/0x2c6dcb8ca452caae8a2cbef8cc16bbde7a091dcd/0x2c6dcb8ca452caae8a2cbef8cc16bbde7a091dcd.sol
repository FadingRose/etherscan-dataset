...
contract JOEDED is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JOEDED";
    string private constant _symbol = unicode"JOEDED";
    ...
    constructor () {
        _taxWallet = payable(0x8E882E4843B4ABABc33F94AefA3f8a6F1909343A);
