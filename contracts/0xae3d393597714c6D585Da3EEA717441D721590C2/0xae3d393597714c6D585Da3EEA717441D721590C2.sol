...
/*
    website  - https://snakkyoneth.art
    twitter  - https://x.com/snakkyoneth
    telegram - https://t.me/snakkyoneth
*/
...
contract Snakky is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private constant _name = unicode"Snakky on Eth";
    string private constant _symbol = unicode"SNAKKY";
    ...
    constructor() {
        _taxWallet = payable(0x1685119737cd3450bAc6B971Af918e73da7De99E);
    ...
    function createSnakky() external onlyOwner {
    ...
    function enableSnakky() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
