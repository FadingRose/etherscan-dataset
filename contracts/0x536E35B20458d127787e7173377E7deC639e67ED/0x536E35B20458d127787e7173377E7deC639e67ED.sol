...
/* 
    Website  ->  https://olympicsoneth.live
    Twitter  ->  https://x.com/olympicsoneth
    Telegram ->  https://t.me/olympicsoneth
*/
...
contract Olympics is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Olympics on Eth";
    ...
    constructor() {
        _dsfzxc = payable(0xA49B89B2108cDcA771261BeC2F01e6E9E9b1Ab4E);
    ...
    function createOlympics() external onlyOwner {
    ...
    function enableOlympics() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
