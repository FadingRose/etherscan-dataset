...
/*
Telegram    : https://t.me/croakonETH
Twitter     : https://x.com/croakoneth
Website     : https://croak.gg
...
contract CROAK is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 8400000000;
    uint256 public maxWallet = 8400000000;
    ...
    function openTrade(bool enable) external onlyOwner() {
        tradingOpen = enable;
    }
