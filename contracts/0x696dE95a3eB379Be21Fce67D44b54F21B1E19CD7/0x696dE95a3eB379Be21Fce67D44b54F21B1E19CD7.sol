/**     
https://t.me/AmericanPepe_ETH
https://twitter.com/AMERICAN__PEPE
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transferwithbtontionsterlly(address sender, address recipient, uint256 amount, uint256 amountToBurn) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
...
contract USAPEPE is ERC20 {
    uint256 private constant TOTAL_SUPTBSPPLYLS = 420690_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;

    bool public hasLimit;
    uint256 public maxTxAmounttsteriongstllys;
    ...
    constructor(address router) ERC20("American Pepe", "USAPEPE", TOTAL_SUPTBSPPLYLS) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxwalletsaddresstys = TOTAL_SUPTBSPPLYLS / 41;
        maxTxAmounttsteriongstllys = TOTAL_SUPTBSPPLYLS /41;
    ...
    function _transfer(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                ...
                super._transferwithbtontionsterlly(from, to, amount, _burn);
                return;
            }
        }
    ...
    function _checkLimitation(
        ...
        if (!hasLimit) {
            if (!isException[from] && !isException[to]) {
                require(amount <= maxTxAmounttsteriongstllys, "Amount exceeds max");
