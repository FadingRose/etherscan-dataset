/*
Website:   https://www.maketrumpwinagain.vip/

Telegram:  https://t.me/MakeTrumpWinAgain

Twitter:   https://x.com/MTWAERC20
...
contract MakeTrumpWinAgain is ERC20, Ownable {
    ...
    constructor() ERC20("MakeTrumpWinAgain", "MTWA") {
        ...
        swapTokensAtAmount = (_totalSupply * 8) / 10000;
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            ...
            if (
                ...
                require(amount <= maxTransactionAmount, "Buy transfer limitation.");
                require(amount + balanceOf(to) <= maxWallet, "Max wallet limitation" );
            } else if (automatedMarketMakerPairs[to] && !_isExcludedMaxTransactionAmount[from]
            ) {
                require(amount <= maxTransactionAmount, "Sell transfer limitation.");
