...
contract MAGAnator is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MAGAnator";
    string private constant _symbol = unicode"MAGANATOR";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x16eD9bB67112C59eE61F7A50E55c2D75991beD87);
