...
/*  
    website  : https://jeetbusters.live
    twitter  : https://x.com/jeetbusterseth
    telegram : https://t.me/jeetbusterseth
*/
...
contract Jeetbusters is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Jeetbusters on Eth";
    ...
    constructor() {
        _nn_rw = payable(0xC5913F2782b0D5c31A724688CEfF4530f8dB6D98);
    ...
    function enableJeets() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }

    function createJeets() external onlyOwner {
