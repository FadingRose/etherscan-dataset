...
contract MoonTaurus is Ownable, IERC20, IERC20Metadata {
    ...
    string private _name = "MoonTaurus";
    string private _symbol = "MNTR";
    ...
    function setFee(uint256 _taxPercent) public onlyOwner {
        require(_taxPercent <= 5, "tax can't be more than five percent");
        tax = _taxPercent;
    }
}
