...
contract BullishMaga is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bullish Maga Coin";
    string private constant _symbol = unicode"BMC";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x22788C3E2d2B5e683e79BeF19Cc8E82494bF5876);
