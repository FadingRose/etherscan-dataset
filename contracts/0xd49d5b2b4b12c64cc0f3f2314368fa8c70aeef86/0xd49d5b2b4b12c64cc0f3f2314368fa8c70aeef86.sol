...
contract Trump is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Republican Nominee"; 
    string private constant _symbol = unicode"TRUMP";

    uint8 public buyTax = 25; 
    uint8 public sellTax = 45;

    address public marketingWallet = 0xF07377Dc8a648Bce07E8FC616a415946e649f0B2; 
