...
contract ConstantReturnStaking is Ownable {
    ...
    uint public REWARD_RATE_X_100 = 80000;
    ...
    // max pool size
    uint public maxPoolSize = 3700000e18;
    ...
    function claim() external noContractsAllowed notDuringEmergency {
        ...
        if (amount > 0) {
            ...
            require(Token(TRUSTED_REWARD_TOKEN_ADDRESS).transfer(msg.sender, amount), "Could not transfer earned tokens.");  
