...
contract ACHIWIF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ACHIWIF";
    string private constant _symbol = unicode"ACHIWIF";
