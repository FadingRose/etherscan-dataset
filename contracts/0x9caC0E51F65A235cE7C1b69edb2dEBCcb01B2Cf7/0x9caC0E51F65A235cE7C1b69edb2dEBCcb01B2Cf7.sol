...
/*
Neiro Sato Coin is not just another cryptocurrency; it's a tribute to the legacy of Doge, inspired by the iconic Shiba Inu's owner, Neiro Sato. Neiro Sato has been a pivotal figure in the internet's favorite meme culture, bringing joy and humor to millions worldwide. Now, we honor her by launching a coin that captures the essence of community, innovation, and growth.

Website :   https://www.neirosato.xyz
Telegram : https://t.me/neirosato_eth
Twitter :     https://x.com/neirosato_eth
*/
...
contract SATO is ERC20, Ownable {
    ...
    string private constant _name = "Neiro Sato";
    ...
    function satoNei() external onlyOwner() {
        tradingOpen = true;
    }
