...
/*
  x: https://x.com/DMAGA_ETH
  telegram: https://t.me/dmaga_eth
*/
...
contract DMAGA  is Context, IERC20, Ownable {
    ...
    function lowerInitialTax(uint256 buy, uint256 sell) external onlyOwner {
    ...
    function lowerFinalTax(uint256 buy, uint256 sell) external onlyOwner {
