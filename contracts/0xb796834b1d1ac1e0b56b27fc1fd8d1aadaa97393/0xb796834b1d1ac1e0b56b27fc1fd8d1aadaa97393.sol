...
contract Mystic is ERC20Base, ReentrancyGuard {
    uint256 public maxSupply = 150000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted

    constructor() payable ERC20Base("Mystic", "MTC") {
