/**
    Website: https://neirostandard.xyz
    X: https://x.com/neiro_std
...
contract NBAR is Context, IERC20, Ownable {
    ...
    address payable private _nbarWallet;
    ...
    function openNbar() external onlyOwner {
