...
/*
Twitter:
X.com/captaintrumpamc

Telegram:
https://t.me/captaintrumperc
...
contract CaptainAmericaTrumP is ERC20, Ownable {
    ...
    string private constant _name = "Captain America TrumP";
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 30 && _sellFee <= 80, "Fees cannot exceed 80%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
