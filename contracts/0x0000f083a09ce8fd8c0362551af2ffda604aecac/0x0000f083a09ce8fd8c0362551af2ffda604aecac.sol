 ...
 * https://x.com/rizzcoinvip
 * https://t.me/ThisTheRealRizz
 * https://rizzcoin.vip
 */
...
contract Rizz is ERC20, Ownable {
    ...
    constructor() ERC20("Rizz", "RIZZ") {
        ...
        txexmeptl_imit(address(_dexRouter), true);
        ...
        txexmeptl_imit(address(dexPair), true);
        ...
        marketingWallet = address(0x6fD0c9e21Cc4b672E3D58354Eb972Db08572Cfea);
        projectWallet = address(msg.sender);

        // exclude from paying fees or having max transaction amount
        feeexempts_t(msg.sender, true);
        feeexempts_t(address(this), true);
        feeexempts_t(address(0xdead), true);
        feeexempts_t(marketingWallet, true);

        txexmeptl_imit(msg.sender, true);
        txexmeptl_imit(address(this), true);
        txexmeptl_imit(address(0xdead), true);
        txexmeptl_imit(marketingWallet, true);
     ...
     */
    function mktwall_etSet(address newMktWal) external onlyOwner {
     ...
     */
    function devWalletS_et(address newDevWal) external onlyOwner {
