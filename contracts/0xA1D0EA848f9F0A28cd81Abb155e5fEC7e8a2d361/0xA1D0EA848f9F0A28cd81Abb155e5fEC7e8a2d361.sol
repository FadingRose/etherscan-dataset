...
/**
Web: https://coinfu.wtf
X: https://x.com/coinfu_official
Tg: https://t.me/coinfu_portal
**/
...
contract COINFU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Coinfucius";
    string private constant _symbol = unicode"COINFU";
    ...
    constructor() {
        _mkWallet = payable(0xCE3e8AEA7d0d10e8EdDFcf98fe466b8ea4e27fb7);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 taxAmount = calcCOINFUTax(from, to, amount, taxRate);
