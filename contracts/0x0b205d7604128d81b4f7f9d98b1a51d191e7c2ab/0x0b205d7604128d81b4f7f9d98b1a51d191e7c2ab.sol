...
contract HOPO_PIPO_LAUNCH_TOMORROW_marketing_contrat_HOPO_PIPO {
    string public constant NAME = "HOPO PIPO LAUNCH TOMORROW marketing contrat";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7000000000 * (10 ** uint256(DECIMALS));
