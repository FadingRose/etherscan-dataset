...
/**
The Draggy .  Dragon has taken over America. He owns your debt, vaccines, and is sending drugs into your streets… now he comes to take on ETH with $DRAGGY

Web : https://www.chinesedragon.live
Tg    : https://t.me/draggy_erc20
X      :  https://x.com/draggy_erc
  */
...
contract Draggy is Context, IERC20, Ownable {
    ...
    uint256 private constant _initialBuyTax = 13;
    uint256 private constant _initialSellTax = 13;
    ...
    constructor() {
        _feeEcos = payable(0x5b864c69816D4edC9162Cbd2D162454fE8eA1BE1);
    ...
    function eatPair() external onlyOwner {
    ...
    function bananaStart() external onlyOwner {
