...
Web: https://darkvbeth.xyz
X: https://x.com/darkvbETH
Tg: https://t.me/darkvbETH
...
contract DARKVB is ERC20, Ownable {
    ...
    string private constant _name = "Dark Vitalik Buterin";
    string private constant _symbol = "DARKVB";
    ...
    uint256 public swapTokensAtAmount = 1_000_000_000 * 1e18;
    ...
    function setFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 30 && _sellFee <= 40, "Fees cannot exceed 50%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
