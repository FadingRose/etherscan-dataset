...
/*
    website  : https://cocketh.live
    twitter  : https://x.com/cockoneth
    telegram : https://t.me/thecockoneth
*/
...
contract TheCock is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private constant _name = unicode"The Cock";
    string private constant _symbol = unicode"COCK";

    uint256 private xjs = 79;
    uint256 private hcv = 25;
    ...
    constructor() {
        _taxWallet = payable(0xa7ea28325672A0f23C13B4b058e5c966BB0685A6);
    ...
    function createTheCock() external onlyOwner {
    ...
    function enableTheCock() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
