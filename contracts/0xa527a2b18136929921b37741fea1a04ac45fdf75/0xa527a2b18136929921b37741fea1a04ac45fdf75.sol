...
contract ContractforStup is ERC20, Ownable {
    ...
    function removelmts() external onlyOwner {
 ...
 function opentrade(uint256 _blocks) external payable onlyOwner {
