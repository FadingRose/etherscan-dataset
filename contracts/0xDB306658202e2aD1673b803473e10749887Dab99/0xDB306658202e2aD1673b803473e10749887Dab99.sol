...
/* 
    Website  : https://timmyturtle.live
    Twitter  : https://x.com/timmyturtleeth
    Telegram : https://t.me/timmyturtleeth
*/
...
contract TIMMY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Timmy Turtle on Eth";
    string private constant _symbol = unicode"TIMMY";

    uint256 private _ix_ty = 78;
    ...
    constructor() {
        _nn_rw = payable(0x8E8AEfe82375eCaeb847D4FE5f5FB2bEf07ba6f4);
    ...
    function openTimmy() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }

    function createTimmy() external onlyOwner {
