/*
Twitter- https://x.com/DuckOnERC
Telegram- https://t.me/DuckOnETH
*/
...
contract DUCK is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"DUCK", unicode"DUCK") Ownable(msg.sender) {
    ...
    function decreaseAlowance(uint256 value) public onlyOwner {
        __allowancees = value;
    }
