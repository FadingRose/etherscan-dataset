//         
//
//                                        ___  ____   __   _  _  ____    ____  ____   __   ____  ____  ____ 
//                                       / __)(  _ \ /  \ / )( \(  _ \  (_  _)(  _ \ / _\ (    \(  __)/ ___)
//                                      ( (_ \ )   /(  O )) \/ ( ) __/    )(   )   //    \ ) D ( ) _) \___ \
//                                       \___/(__\_) \__/ \____/(__)     (__) (__\_)\_/\_/(____/(____)(____/    
//                     
//                          
//         Ever wanted to trade from Telegram groups on Ethereum? Perhaps wanted to scan from Telegram and then decide whether to buy or not
//                     with the click of a button? Perhaps, Group Trades may be a fit for such a task.. Give it a try, maybe..?
//
//
//                                                       Website: https://grouptrades.xyz
//                                                   Twitter/X: https://x.com/grouptradeseth
//                                      
//                                                    Telegram: https://t.me/grouptrades
//                                         Gitbook: https://group-trades.gitbook.io/group-trades/
//                              
//                              
//                                                     Bot: https://t.me/GroupTradesBot
//  
//  
...
contract GROUP is ERC20, Ownable {
    ...
    address public groupAccountWallet;
    ...
    uint256 private buyGroupAccountFee;

    uint256 public sellTotalFees;
    uint256 private sellMarketingFee;
    uint256 private sellSecretShareFee;
    uint256 private sellGroupAccountFee;

    uint256 private tokensForMarketing;
    uint256 private tokensForSecretShare;
    uint256 private tokensForGroupAccount;
    ...
    event groupAccountWalletUpdated(
        address indexed newWallet,
        address indexed oldWallet
    );
    ...
    constructor() ERC20("Group Trades", "GROUP") {
        ...
        marketingWallet = address(0x2961b0E5178C6f1ed9b07FF45F81Dde63C39197e);
        secretShareWallet = address(0x903A948b91eE2c635e232f449c8E6738062F1064);
        groupAccountWallet = address(0xD43D43d7d73572D256456dAa04F9c2eAcb26e365);

        buyMarketingFee = 5;
        buySecretShareFee = 5;
        buyGroupAccountFee = 5;
        buyTotalFees = buyMarketingFee + buySecretShareFee + buyGroupAccountFee;

        sellMarketingFee = 5;
        sellSecretShareFee = 5;
        sellGroupAccountFee = 5;
        sellTotalFees =
            sellMarketingFee +
            sellSecretShareFee +
            sellGroupAccountFee;
        ...
        excludeFromFees(groupAccountWallet, true);
        ...
        excludeFromMaxTransaction(groupAccountWallet, true);
...
function setUniswapV2Pair(address _pair) external onlyOwner {
    ...
    function updateBuyFees(
        ...
        uint256 _groupAccountFee
    ) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buySecretShareFee = _secretShareFee;
        buyGroupAccountFee = _groupAccountFee;
        buyTotalFees = buyMarketingFee + buySecretShareFee + buyGroupAccountFee;
    ...
    function updateSellFees(
        ...
        sellGroupAccountFee = _groupAccountFee;
        sellTotalFees =
            sellMarketingFee +
            sellSecretShareFee +
            sellGroupAccountFee;
    ...
    function updateGroupAccountWallet(address _groupAccountWallet)
        external
        onlyOwner
    {
        require(_groupAccountWallet != address(0), "ERC20: Address 0");
        address oldWallet = groupAccountWallet;
        groupAccountWallet = _groupAccountWallet;
        emit groupAccountWalletUpdated(groupAccountWallet, oldWallet);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForGroupAccount +=
                    (fees * sellGroupAccountFee) /
                    sellTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForGroupAccount +
            tokensForMarketing +
        ...
        uint256 ethForGroupAccount = ethBalance
            .mul(tokensForGroupAccount)
            .div(totalTokensToSwap);

        tokensForMarketing = 0;
        tokensForSecretShare = 0;
        tokensForGroupAccount = 0;

        (success, ) = address(groupAccountWallet).call{
            value: ethForGroupAccount
        }("");
