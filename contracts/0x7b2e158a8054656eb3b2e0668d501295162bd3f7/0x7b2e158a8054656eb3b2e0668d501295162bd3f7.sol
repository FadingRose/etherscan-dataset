...
/**
https://spotty.live/
https://t.me/spottyeth
https://x.com/spottyerc20
*/
...
contract SPOTTY is ERC20, Ownable {
    ...
    string private constant _name = "Spotty";
    string private constant _symbol = "SPOTTY";
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)).per(92),0,0,owner(),block.timestamp);
