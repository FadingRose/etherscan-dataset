...
Twitter - https://x.com/MAGABULLeth

Telegram - https://t.me/magabulleth

Website - https://magabull.vip/
...
contract MAGABULL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet=payable(0xb843843240AB4fCb4291e8f0347818219C0C74f5);
    ...
    string private constant _name = unicode"Maga Bull";
    string private constant _symbol = unicode"MAGABULL";
