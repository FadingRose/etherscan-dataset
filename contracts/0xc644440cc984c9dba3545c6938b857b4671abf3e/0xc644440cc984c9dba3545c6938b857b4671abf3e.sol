...
contract HOPO_PIPO_HOPO_pipo_HOPO_PIPO_HOPO_pipo {
    string public constant NAME = "HOPO PIPO HOPO pipo HOPO PIPO HOPO pipo";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7666333000 * (10 ** uint256(DECIMALS));
