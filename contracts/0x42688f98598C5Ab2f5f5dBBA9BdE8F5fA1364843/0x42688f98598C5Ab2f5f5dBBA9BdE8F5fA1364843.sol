...
contract BridgeContract is OApp {
    ...
    uint256 public feeReceiverAmount;
    ...
    constructor(
        ...
        feeReceiverAmount = 975; // 0.975% = 975/100000
    }
     ...
     * @param receiver The address that should receive the majority of tokens
     * @param totalAmount The total amount of tokens to be distributed
     */
    function distributeTokens(address receiver, uint256 totalAmount)
        internal
        returns (uint256 receiverAmount)
    {
        uint256 feeAmount = (totalAmount * feeReceiverAmount) / 100000;
        receiverAmount = totalAmount - feeAmount;

        token.transferFrom(receiver, address(this), receiverAmount);
        token.transferFrom(receiver, feeReceiverMp, feeAmount);

        token.burnBridge(address(this), receiverAmount);
    }
    ...
    function setFeeReceiverTransferAmount(uint256 percentage) public onlyOwner {
        feeReceiverAmount = percentage;
    }
}
