...
* Heroes don't need masks, their actions speak for them !
...
contract HeroTrum is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 410_000_000_000 * 10**_decimals;
    string private constant _name = unicode"HeroTrum";
