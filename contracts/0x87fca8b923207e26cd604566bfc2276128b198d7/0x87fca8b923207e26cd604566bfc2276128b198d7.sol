...
Links:
    ...
    Twitter - https://x.com/TRMPeth

Crypto meets political revolution. Join the movement and let's make crypto great again with $TRMP!

➡️  10/10 init tax - 0/0 final tax + LP lock + Renounce

🖥 Token Details:
 
    Token Name: Make Trump President Again 
    Token Symbol: $TRMP
...
contract TRMP is Context, IERC20, Ownable {
    ...
    string  private constant _symbol = unicode"TRMP";
