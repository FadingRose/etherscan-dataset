...
// Telegram: https://t.me/PumpchanETH
// X: https://www.instagram.com/p/C6g0G5apMGR/?igsh=YnV1andnbDhqMTY0
...
contract Pumpchan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    address payable private _taxWallet=payable(0x46c3f031eA89b3F43C447F238fb4966CbD25Db14);
    ...
    string private constant _name = unicode"Pumpchan";
    string private constant _symbol = unicode"PUMPCHAN";
