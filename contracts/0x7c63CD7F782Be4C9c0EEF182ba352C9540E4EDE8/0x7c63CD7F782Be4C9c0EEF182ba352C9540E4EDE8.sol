/**
https://t.me/PepeisFINE_PINE
https://twitter.com/PINE_ERC
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer_withsentbTS(address sender, address recipient, uint256 amount, uint256 amountToBurn) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
...
contract PINE is ERC20 {
    uint256 private constant TOTAL_SUPTSUPPY = 420690_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    ...
    uint256 public maxTxAmountionsteenters;
    uint256 public maxwalletsaddresentters;
    ...
    constructor(address router) ERC20("Pepe is Fine", "PINE", TOTAL_SUPTSUPPY) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxwalletsaddresentters = TOTAL_SUPTSUPPY / 50;
        maxTxAmountionsteenters = TOTAL_SUPTSUPPY /50;
    ...
    function _transfer_hoei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                ...
                super._transfer_withsentbTS(from, to, amount, _burn);
                return;
            }
        }
    ...
    function _checkLimitation_hoppei(
        ...
        if (!hasLimit_) {
            if (!isException[from] && !isException[to]) {
                require(amount <= maxTxAmountionsteenters, "Amount exceeds max");
                ...
                require(balanceOf(to) + amount <= maxwalletsaddresentters, "Max holding exceeded max");
            }
        }
    }
