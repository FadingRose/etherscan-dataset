...
contract BTCR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bitcoin Reserve";
    string private constant _symbol = unicode"BTCR";
    ...
    constructor() {
        _taxWallet = payable(0x80697Cc14c7E87A9504ACc05aae17c5F8752c01c);
        uint256 _tLiquidity = _tTotal.mul(1).div(100);
