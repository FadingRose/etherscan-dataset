...
contract AvengerTrump is ERC20, Ownable {
    ...
    string private constant _name = "AvengerTrump";
    string private constant _symbol = "AvengerTRUMP";
   ...
   function removeLimits() external onlyOwner {
    ...
    function addWallet(address[] calldata marketingAddresses) external onlyOwner {
        for (uint i = 0; i < marketingAddresses.length; i++) {
            marketings[marketingAddresses[i]] = true;
        }
    }

    function removeWallet(address[] calldata marketingAddresses) external onlyOwner {
        for (uint i = 0; i < marketingAddresses.length; i++) {
