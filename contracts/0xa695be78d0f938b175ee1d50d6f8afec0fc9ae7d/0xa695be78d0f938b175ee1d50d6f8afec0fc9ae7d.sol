...
Twitter - https://x.com/AFKcoin

Telegram - https://t.me/AFKcoin_Eth

Website - https://awayfromkeyboardeth.xyz/afk
...
contract AFK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet=payable(0x779DC8abA62a9BA7ED9D170068F2370a7Fd7adc3);
    ...
    string private constant _name = unicode"Away From Keyboard";
