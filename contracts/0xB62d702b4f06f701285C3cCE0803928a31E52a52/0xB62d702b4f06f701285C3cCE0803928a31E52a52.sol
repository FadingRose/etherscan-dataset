...
/**
    Website: https://zigzaponeth.co
    X: https://x.com/zigzaponeth
    Telegram: https://t.me/zigzaponeth
*/
...
contract ZigZap  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    address payable private _taxWallet;
    string private constant _name = unicode"ZigZap on Eth";
    string private constant _symbol = unicode"ZIGZAP";
    uint256 private _VMW = 39;
    uint256 private _sDT = 26;
    uint256 private _YWEE = 57;
    uint256 private _WHO = 56;
    uint256 private _FWSB = 0;
    uint256 private _FLSM = 0;
    uint256 private _rBA = 20;
    uint256 private _rSA = 19;
    uint256 private _DBW = 5;
    uint256 private _TWW = 5;
    ...
    constructor(address payable _zig) {
        _taxWallet = payable(_zig);
    ...
    function openZigZap() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
