...
contract Trump is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dark Donald Trump"; 
    string private constant _symbol = unicode"DDONALD";

    uint8 public buyTax = 25; 
    uint8 public sellTax = 45;

    address public marketingWallet = 0xdb52DB2dAA6a7605C6b373E84c250374Cc2F4081; 
