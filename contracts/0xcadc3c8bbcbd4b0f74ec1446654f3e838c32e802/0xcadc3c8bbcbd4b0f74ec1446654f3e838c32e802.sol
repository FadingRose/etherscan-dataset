...
contract Hopo_Pipo_ONLINE_IN_48h {
    string public constant NAME = "Hopo_Pipo_ONLINE_IN_48h";
    string public constant SYMBOL = "POPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7666000000 * (10 ** uint256(DECIMALS));
