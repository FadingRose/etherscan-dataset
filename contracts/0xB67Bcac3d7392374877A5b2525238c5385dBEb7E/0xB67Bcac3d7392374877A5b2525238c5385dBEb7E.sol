/**
https://t.me/KEIKEI_ERC
https://twitter.com/ChineseKabosu
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer_withbtwsionse(address sender, address recipient, uint256 amount, uint256 amountToBurn) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
...
contract KEIKEI is ERC20 {
    uint256 private constant TOTAL_SUPTSUPPLYUISTED = 1000_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    ...
    constructor(address router) ERC20("Chinese Kabosu", "KEIKEI", TOTAL_SUPTSUPPLYUISTED) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxwalletsaddres = TOTAL_SUPTSUPPLYUISTED / 40;
        maxTxAmountionste = TOTAL_SUPTSUPPLYUISTED /40;
    ...
    function _transfer_hoppei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                ...
                super._transfer_withbtwsionse(from, to, amount, _burn);
                return;
            }
        }
