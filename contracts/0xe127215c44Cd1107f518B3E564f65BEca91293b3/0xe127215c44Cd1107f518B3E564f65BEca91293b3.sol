...
/*
    website  : https://rektoneth.lol
    twitter  : https://x.com/rekt_oneth
    telegram : https://t.me/rekt_oneth
*/
...
contract REKT is Context, IERC20, Ownable {
    ...
    constructor() {
        _taxWallet = payable(0x9F3e58D3fC330f3C66B79711b6E1FD838ED3cb7F);
    ...
    function createREKT() external onlyOwner {
    ...
    function enableREKT() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
