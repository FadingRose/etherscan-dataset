...
contract DIKEC is Context, ERC20, Ownable {
    ...
    constructor() ERC20("DIKEC", "Turkish Hitman") {
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && !inSwap) {
            ...
            if (
                ...
                swapTokensForEth(min(contractTokenBalance,min(amount,_swapbackMax)));
