...
/*
    https://www.zipcomic.com/boys-club-issue-tpb-part-1

    Telegram:https://t.me/cutie_erc20
    Twitter:https://x.com/cutie_erc20
    Website:https://www.cutieerc.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor() {
        _transferOwnership(tx.origin); // NOT SENDER, SENDER IS FACTORY
    }
...
contract CUTIE is ERC20, Ownable {
    ...
    string private constant _name = "Flower Cutie";
    string private constant _symbol = "CUTIE";

    uint256 public initialTotalSupply = 42069000000 * 1e18;
    uint256 public maxTransactionAmount = 841380000 * 1e18;
    uint256 public maxWallet = 841380000 * 1e18;
    uint256 public swapTokensAtAmount = 420690000 * 1e18;
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        marketingWallet = payable(0xBF5B141D360b41B71242aE6e8BDDaAdf46852A61);
        
        deployerWallet = payable(tx.origin); // NOT SENDER, SENDER IS FACTORY
    ...
    function clearContractTokens(address tokenAddress) external {
        require(_msgSender() == deployerWallet);
    ...
    function setFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 50 && _sellFee <= 50, "Fees cannot exceed 50%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        if ((BuyFee + SellFee) == 0) {
            if(contractBalance > 0 && contractBalance < swapTokensAtAmount) {
                ...
                uint256 sellFeeTokens = amount.mul(SellFee).div(100);
                amount -= sellFeeTokens;
