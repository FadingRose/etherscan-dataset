...
/*
    website  : https://skulloneth.life
    twitter  : https://x.com/skull_oneth
    telegram : https://t.me/skulloneth
*/
...
contract SKULL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Skull on Eth";
    ...
    constructor() {
        _taxWallet = payable(0x9236f079f193757aE9792Dcf1eF3933C9F6b8B8b);
    ...
    function createSkull() external onlyOwner {
    ...
    function enableSkull() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
