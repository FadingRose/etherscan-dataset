...
/*
Jesus's been a Trump fan since day one. He's ​saved him so many times I've lost count, even from that ​recent assassination attempt...

Website :   https://donaldjesustrump.live
Telegram : https://t.me/jesustrump_eth
Twitter :     https://x.com/jesustrump_eth
*/
...
contract JESUS is ERC20, Ownable {
    ...
    string private constant _name = "DonaldJesusTrump";
    ...
    function startJESUS() external onlyOwner() {
        tradingOpen = true;
    }
