 ...
 * SPDX-License-Identifier: MIT
 It used to be called 建国(Jiangxi)because it commemorated the founding of the People’s Republic of China.川 (Chuan)and trump,They both have the same pronunciations .so,we are used to ” last name+First name”
 Trump is America’s gift to China

 * Website: https://chuanjinguo.fun/
 * Twitter: https://x.com/ChuanJinguERC20
 * Telegram: https://t.me/TrumpinERC20
 */
...
contract TRUMPIN is ERC20, Ownable {
    ...
    constructor() ERC20("Chuan Jinguo", "TRUMPIN") {
        ...
        marketingWallet = address(0x7DB2535F537C71a47980fCcA53ba402924FDF063);
