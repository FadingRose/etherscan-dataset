...
contract HOPO_PIPO_MARKETING_CONTRACT_HOPO_PIPO {
    string public constant NAME = "HOPO PIPO MARKETING CONTRACT HOPO PIPO";
    string public constant SYMBOL = "HOPO";
    uint8 public constant DECIMALS = 18;
    uint256 public constant TOTAL_SUPPLY = 7555000000 * (10 ** uint256(DECIMALS));
