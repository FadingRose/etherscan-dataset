...
/* 
    website: https://eazypeazy.art
    twitter: https://x.com/eazypeazyeth
    telegram: https://t.me/eazypeazyeth
*/
...
contract EZPZ is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EazyPeazy on ETH";
    ...
    constructor() {
        _dsfzxc = payable(0x1010F83fa0E1D5AE500C74B845229D0537E2A0B1);
    ...
    function createEZPZ() external onlyOwner {
    ...
    function enableEZPZ() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
