...
/**
Life is too short to be serious. Invest in $BROJAK, join your Wojak family, and let the chaos begin!
Website :   https://brojakoneth.xyz
Telegram : https://t.me/brojak_eth
Twitter :     https://x.com/brojak_eth
*/
...
contract BROJAK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Brojak";
    string private constant _symbol = unicode"BROJAK";
    ...
    constructor() {
        _expWallet = payable(0xa035bF7CbE269d9978c390eec0b7a5DB0CfD0C18);
