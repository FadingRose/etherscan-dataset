...
/**
Website:       https://www.erictrustedfunds.live
Telegram:     https://t.me/etf_erc
Twitter:          https://x.com/etfcoin_eth
  */
...
contract ETF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Eric Trusted Funds";
    ...
    constructor() {
        _feeEcos = payable(0xB9e49A4e0AEa93dC50982F2953544Fe43f389Eda);
    ...
    function wenETF() external onlyOwner {
    ...
    function startETF() external onlyOwner {
