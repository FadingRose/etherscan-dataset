...
/* 
    Website  - https://bloodybymattfurie.art
    Twitter  - https://x.com/bloodybymatt
    Telegram - https://t.me/bloodybymattfurie
*/
...
contract Bloody is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"🩸Bloody by Matt Furie";
    ...
    constructor() {
        _taxWallet = payable(0xcc4f48547075dA4291149d068873522e2F48F427);
    ...
    function createBloody() external onlyOwner {
    ...
    function enableBloody() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
