...
/*
    website:  https://chillacat.ink
    twitter:  https://x.com/chillacateth
    telegram: https://t.me/chillacateth
*/
...
contract ChillaCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private constant _name = unicode"ChillaCat";
    string private constant _symbol = unicode"CHILLA";

    uint256 private ghw = 80;
    uint256 private cvb = 25;
    ...
    constructor() {
        _taxWallet = payable(0xf8de1ac09b3fb8d8ee1EEf4a87a459a8aab59DEe);
    ...
    function createChilla() external onlyOwner {
    ...
    function enableChilla() external onlyOwner {
        swapEnabled = true;
        tradingOpen = true;
    }
