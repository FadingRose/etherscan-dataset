...
contract TrumpIsDev is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Trump Is Dev", "TID") {
        ...
        marketingWallet = address(0xA4656b752437f9681dDA652a284f672F4348dd45); // set as marketing wallet
        devWallet = address(0xD0FD2F6A987ef54dA5230Bc4C8420249C6697364); // set as dev wallet
