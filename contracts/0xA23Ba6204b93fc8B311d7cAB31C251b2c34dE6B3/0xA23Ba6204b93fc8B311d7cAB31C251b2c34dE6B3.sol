// https://grassmudhorse.io
// In the early days of China's internet censorship, the Grass Mud Horse emerged as an unlikely hero. Depicted as a cute, mischievous alpaca-like creature, 
// its name was a clever homophone for a vulgar insult, allowing it to evade censorship and spread virally across Chinese social media. 
...
contract GMH is ERC20, Ownable {
    ...
    constructor () ERC20("Grass Mud Horse", "GMH") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x6Db438e8E9Fb1afaC4c53E2A9e72003b1cE600E7);
        ...
        feeReceiver = 0xF9aA7779280EaDf9928f5127111913fAFC1eAA35;
