...
Telegram - https://t.me/peindarifhat
Twitter - https://twitter.com/PeindaRifHat
...
contract PeindaRifHat is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 2221051725e4 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x7c742474c1e8409B8ACb0B732963be0751FE55c1;
    address private devWallet = 0x7A75e1f39f39BfBB06348c9e585730c744938389;
    ...
    Taxes public taxes = Taxes(99, 0, 99);
    Taxes public sellTaxes = Taxes(99, 0, 99);
    ...
    constructor() ERC20("PeindaRifHat", "$RIF") {
        _tokengeneration(msg.sender, 88842069e7 * 10**decimals());
