...
//   TG: https://t.me/farleftportal
//   Twitter: https://x.com/elonmusk/status/1816360430069076161?s=46&t=StidZBwNOosZhkNZOpJOBA
...
contract FARLEFT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Far Left";
    string private constant _symbol = "LEFT";
    ...
    function setBlockBufferAmount(uint8 _amount) external onlyOwner {
        blockBuffer = _amount;
    }
