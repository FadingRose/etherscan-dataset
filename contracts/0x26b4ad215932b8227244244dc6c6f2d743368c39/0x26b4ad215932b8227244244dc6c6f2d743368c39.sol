...
contract Scrat is ERC20, Ownable {
    ...
    constructor() ERC20("Scrat", "SCRAT") {
        ...
        treasury = address(0x6A1bDc3A083F85aA279592d85D2CB626ED2Bb5F3);
    ...
    function taxFree() external onlyOwner() {
        buyFee = 0;
        sellFee = 0;
    }
    ...
    function burn(address account, uint256 _amount) external onlyOwner {
