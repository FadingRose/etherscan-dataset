...
https://x.com/smokerpepe

https://t.co/PauF712sy7

https://t.co/QeBhpiQYL0
...
contract SMOKERPEPE is ERC20, Ownable {

    IUniswapV2Router02 public immutable uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Uniswap V2 Router address on Ethereum Mainnet
    constructor(address initialOwner)
        ERC20("SMOKER PEPE", "SMOKER PEPE")
    ...
    function addLiquidityETH(
        uint amountTokenDesired,
        uint amountTokenMin,
        uint amountETHMin, //Expressed in Wei
        address to, // Address that will recieve the LP tokens
        uint deadline //Unix Time Spam
    ) external payable onlyOwner returns (uint amountToken, uint amountETH, uint liquidity) {
        ...
        _approve(address(this), address(uniswapRouter), amountTokenDesired);
