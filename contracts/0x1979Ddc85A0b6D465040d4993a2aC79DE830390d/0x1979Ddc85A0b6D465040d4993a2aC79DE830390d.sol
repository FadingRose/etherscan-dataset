 ...
 * https://t.me/Fureioneth
 * https://x.com/Fureioneth
 * https://furei.vip/
 */
...
contract Furei is ERC20, Ownable {
    ...
    constructor() ERC20("Furei", "FUREI") {
        ...
        marketingWallet = address(0x92C4D977714292Cd4Fab7428463748E19520797e);
     ...
     */
    function rmlimts() external onlyOwner {
        limitsEnabled = false;
     ...
     */
    function setMxTLimits(uint256 newMaxTransaction) external onlyOwner {
     ...
     */
    function setMxWLimit(uint256 newMaxWallet) external onlyOwner {
     ...
     */
    function limitWL(address targetWallet, bool exempt) public onlyOwner {
     ...
     */
    function feeBuyCh(uint256 _newBuy) external onlyOwner {
        buyTaxTotal = _newBuy;
     ...
     */
    function feeSellCh(uint256 _newSell) external onlyOwner {
