...
/**
The Sweets have arrived to finally satisfy your sugary degenerate cravings:candy:

Website :   https://sweetsoneth.live
Telegram : https://t.me/sweetscoin_eth
Twitter :     https://x.com/sweetscoin_eth
...
contract Sweets is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sweets";
    string private constant _symbol = unicode"SWEETS";
    ...
    constructor() {
        _feeEcos = payable(0xe39E5623A2d1f39dc68fDC05614801f8eB8D2631);
    ...
    function getSweet() external onlyOwner {
    ...
    function loveSweet() external onlyOwner {
