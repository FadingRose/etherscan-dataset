...
/*
"Pepe the Frog, the internet's favorite amphibian, is here to brighten 
your day with a touch of humor and a splash of relatable feels!".

https://t.me/lightpepe_erc20
https://x.com/lightpepe_erc20
https://lightpepe.xyz
...
contract LIPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Light Pepe";
    string private constant _symbol = unicode"$LIPE";
    uint256 public _maxTxAmount =   25400000 * 10**_decimals;
    uint256 public _maxWalletSize = 25400000 * 10**_decimals;
