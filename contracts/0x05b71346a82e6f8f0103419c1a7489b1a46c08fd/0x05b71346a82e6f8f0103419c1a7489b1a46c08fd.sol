/*
Telegram: https://t.me/leopefurieeth
Website: https://leopefurie.xyz/
X: https://x.com/leopefurieeth
*/
...
contract leope is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"leope by matt furie";
    string private constant _symbol = unicode"LEOPE";
    ...
    function addMaxWallet(address _account, uint256 amount) external onlyOwner {
