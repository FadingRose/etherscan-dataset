...
contract BlockATMCollect is Ownable,BlockCommon{
    ...
    function collect(address tokenAddr,address[] memory addrList,bool isDefi,uint8 plaType) public checkTokenAddress(tokenAddr) onlyCollect returns (bool){
        ...
        if (isDefi && total > 0){
            IERC20(tokenAddr).transfer(defiAddr,total);
