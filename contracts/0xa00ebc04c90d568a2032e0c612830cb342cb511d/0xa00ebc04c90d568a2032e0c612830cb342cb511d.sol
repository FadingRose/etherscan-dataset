...
/// @custom:security-contact 0xydot@
contract BullishBull is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    constructor(address initialOwner)
        ERC20("Bullish Bull", "BULY")
        ERC20Permit("Bullish Bull")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 2025000000 * 10 ** decimals());
    }
}
